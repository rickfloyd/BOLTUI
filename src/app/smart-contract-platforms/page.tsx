      ...
      <main className="dashboard-grid">
        <section className="center-content">
          ...
          <p className="text-lg text-gray-300 text-center max-w-3xl mx-auto">
            A comprehensive list of platforms that enable the creation and
            execution of smart contracts, driving decentralized applications
            (dApps). This includes Layer-1 blockchains, parachains, sidechains,
            and rollup networks.
          </p>
