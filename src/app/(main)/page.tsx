...
export default function Page() {
    // const { data: nasdaq, loading: nasdaqLoading } = useRealtimeData('indices/nasdaq');
    // const { data: dow, loading: dowLoading } = useRealtimeData('indices/dow');
    // const { data: russell, loading: russellLoading } = useRealtimeData('indices/russell');
    // const { data: dxy, loading: dxyLoading } = useRealtimeData('indices/dxy');
