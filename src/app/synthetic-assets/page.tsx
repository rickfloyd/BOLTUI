    ...
    <>
      ...
      <main className="dashboard-grid">
        <section className="center-content">
          <h1 className="text-3xl font-bold neon-text text-center mt-8">Synthetic Asset Tokens</h1>
          ...
          <div className="w-full overflow-x-auto mt-8">
            <div className="info-table-card">
              <table className="info-table w-full">
                ...
                <tbody>
                  {filteredAssets.map((asset, index) => (
                    <tr key={`${asset.symbol}-${index}`} className="hover:bg-white/5">
              ...
              {filteredAssets.length === 0 && (
                <p className="text-center text-gray-400 py-8">No synthetic assets found matching your search.</p>
              )}
            </div>
          </div>
        </section>
