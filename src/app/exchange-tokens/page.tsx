      ...
      <main className="dashboard-grid">
        <section className="center-content">
          ...
          <p className="text-lg text-gray-300 text-center max-w-3xl mx-auto">
            A list of tokens issued by cryptocurrency exchanges. These tokens
            often provide utility within their native platform, such as reduced
            trading fees, governance rights, or access to exclusive features.
          </p>
