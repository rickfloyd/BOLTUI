      ...
      <main className="dashboard-grid">
        <section className="center-content">
          ...
          <p className="text-lg text-gray-300 text-center max-w-3xl mx-auto">
            A curated list of tokens from the gaming and GameFi ecosystems,
            including platform tokens, in-game currencies, and governance
            assets.
          </p>
          ...
          <div className="mt-8 text-gray-400 text-sm max-w-4xl mx-auto">
            <h3 className="font-bold text-lg text-white mb-2">
              Notes on the GameFi Ecosystem:
            </h3>
            <p>
              The gaming ecosystem is broad and often includes repeated
              ecosystem tokens, marketplace tokens, in-game asset tokens,
              chain-native tokens (Ronin, WEMIX), and many project-specific
              utility tokens. This list includes many ecosystem variants,
              marketplace/infrastructure tokens, and legacy game tokens.
            </p>
          </div>
        </section>
      </main>
