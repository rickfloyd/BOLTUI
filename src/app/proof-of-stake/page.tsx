    ...
    const fetchCoins = async () => {
      try {
        ...
        if (!response.ok) {
          ...
          throw new Error(
            errorData.error || "Failed to fetch Proof of Stake coins.",
          );
        }
      ...
      <main className="dashboard-grid">
        <section className="center-content">
          ...
          <p className="text-lg text-gray-300 text-center max-w-3xl mx-auto">
            These blockchains use staking instead of mining to validate
            transactions, making them more energy-efficient and scalable. This
            list represents top coins by market cap, many of which use a Proof
