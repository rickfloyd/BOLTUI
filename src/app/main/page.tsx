  ...
  useEffect(() => {
    const fetchFeaturedToken = async () => {
      try {
        ...
        const tokenInfo =
          potentialFeaturedTokens[dayIndex % potentialFeaturedTokens.length];
        ...
        const tokenData = allCoins.find(
          (coin: any) => coin.id === tokenInfo.id,
        );
        ...
        if (tokenData) {
          ...
          const hamsterData = allCoins.find(
            (coin: any) => coin.id === "hamster",
          );
              ...
              <CardHeader>
                <CardTitle className="text-2xl neon-text">
                  {loading
                    ...
                    : `Featured Token: ${featuredToken?.name || "N/A"} (${featuredToken?.symbol?.toUpperCase() || "N/A"})`}
                </CardTitle>
              </CardHeader>
              <CardContent>
                {loading ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      <table className="info-table w-full">
                        <tbody>
                          <tr>
                            <td className="neon-cyan">Symbol</td>
                            <td className="text-gray-300">
                              {featuredToken.symbol.toUpperCase()}
                            </td>
                          </tr>
                          <tr>
                            <td className="neon-cyan">Price</td>
                            <td className="text-gray-300 font-numeric">
                              {formatCurrency(featuredToken.current_price)}
                            </td>
                          </tr>
                          <tr>
                            <td className="neon-cyan">Market Cap</td>
                            <td className="text-gray-300 font-numeric">
                              {formatCurrency(featuredToken.market_cap)}
                            </td>
                          </tr>
                          <tr>
                            <td className="neon-cyan">Market Cap Rank</td>
                            <td className="text-gray-300 font-numeric">
                              #{featuredToken.market_cap_rank}
                            </td>
                          </tr>
                          <tr>
                            <td className="neon-cyan">Circulating Supply</td>
                            <td className="text-gray-300 font-numeric">
                              {formatLargeNumber(
                                featuredToken.circulating_supply,
                              )}
                            </td>
                          </tr>
                          <tr>
                            <td className="neon-cyan">Max Supply</td>
                            <td className="text-gray-300 font-numeric">
                              {formatLargeNumber(featuredToken.max_supply) ||
                                "N/A"}
                            </td>
                          </tr>
                          <tr>
                            <td className="neon-cyan">CoinGecko</td>
                            <td>
                              <a
                                href={`https://www.coingecko.com/en/coins/${featuredToken.id}`}
                                target="_blank"
                          ...
                          <tr>
                            <td className="neon-cyan">CoinMarketCap</td>
                            <td>
                              <a
                                href={`https://coinmarketcap.com/currencies/${featuredToken.id}/`}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-cyan-400 hover:underline"
                              >
                    ...
                    <div>
                      <h4 className="text-xl font-bold neon-pink mb-4">
                        🔍 Key Notes
                      </h4>
                      <ul className="list-disc list-inside space-y-2 text-gray-300">
                        <li>
                          This token is selected from a curated list and rotates
                          every 48 hours.
                        </li>
                        <li>Market data is live from the CoinGecko API.</li>
                        <li>
                          Always do your own research (DYOR) before making any
