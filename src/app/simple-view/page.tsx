      ...
      <main className="dashboard-grid">
        <section className="center-content">
          <div className="view-switcher">
            ...
            <Link href="/wcag" className="view-button view-button-wcag">WCAG–W3C</Link>
          ...
          <p className="text-lg text-gray-300 text-center">Live price feeds from Finnhub WebSocket.</p>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto w-full">
            {Object.keys(prices).map(symbol => (
                 <Card key={symbol} className={`data-card ${getGlowClass(symbol)}`}>
                    <CardHeader>
                    ...
                    <CardContent className="text-center">
                        <p className="text-4xl font-bold font-numeric text-white">
                            {prices[symbol] !== null ? prices[symbol]?.toFixed(4) : 'Loading...'}
                        </p>
                    </CardContent>
                </Card>
            ))}
