      ...
      <main className="dashboard-grid">
        <section className="center-content">
          <h1 className="text-3xl font-bold neon-text text-center mt-8">
            Wrapped Assets Encyclopedia (Top 100)
          </h1>
          <p className="text-lg text-gray-300 text-center max-w-3xl mx-auto">
            Wrapped assets are tokens that represent a cryptocurrency from
            another blockchain. They are pegged 1:1 to the original asset,
            enabling cross-chain interoperability and DeFi participation.
          </p>
