...
export default function MetaverseProjectsPage() {
  ...
  const filteredProjects = metaverseProjects.filter((project) =>
      ...
      <main className="dashboard-grid">
        <section className="center-content">
          ...
          <p className="text-lg text-gray-300 text-center max-w-3xl mx-auto">
            A curated list of projects building the metaverse, from virtual
            worlds and gaming platforms to the underlying infrastructure and
            tools.
          </p>
