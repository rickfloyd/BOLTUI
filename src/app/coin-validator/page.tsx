      ...
      <main className="container mx-auto px-4 py-12">
        <div className="center-content max-w-4xl mx-auto">
          ...
          <section className="p-8 rounded-lg bg-black/50 border-2 border-cyan-500/50 shadow-[0_0_25px_rgba(0,255,255,0.3)] w-full">
            <h2 className="text-2xl font-bold text-cyan-300 mb-6 text-center">Validator Checklist</h2>
            ...
            <div className="mt-8 text-center text-gray-400 text-sm">
                <p>Validation scripts use a combination of CoinGecko and Etherscan APIs to pull and verify data.</p>
                <p>This process helps maintain data integrity and provides deeper insights into each asset.</p>
            </div>
          </section>

          <section className="mt-12 w-full">
            <h2 className="text-2xl font-bold text-pink-300 mb-4 text-center">Developer Tooling</h2>
            <p className="text-center text-gray-300 mb-4">
              A script is available in the <code className="bg-gray-800 p-1 rounded-md text-cyan-400">/tools</code> directory to perform these checks.
            </p>
            <div className="bg-gray-900/70 p-6 rounded-lg border border-pink-400/30">
              <h3 className="text-xl font-semibold text-white mb-2">/tools/validate-coingecko-ids.js</h3>
