      ...
      <main className="dashboard-grid">
        <section className="center-content">
          <h1 className="text-3xl font-bold neon-text text-center mt-8">
            Infrastructure & Data Tokens
          </h1>
          <p className="text-lg text-gray-300 text-center max-w-3xl mx-auto">
            A curated list of tokens that power blockchain infrastructure, data
            indexing, oracles, and developer tooling.
          </p>
                ...
                <tbody>
                  {filteredTokens.map((token, index) => (
                    ...
                    >
                      ...
                      <td>
                        <Link
                          href={`https://api.coingecko.com/api/v3/coins/${token.apiId}`}
                          target="_blank"
