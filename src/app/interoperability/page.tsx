      ...
      <main className="dashboard-grid">
        <section className="center-content">
          ...
          <p className="text-lg text-gray-300 text-center max-w-3xl mx-auto">
            A curated list of projects, protocols, and infrastructure tokens
            focused on connecting different blockchain ecosystems, enabling
            assets and data to move between them.
          </p>
