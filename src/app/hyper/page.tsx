...
const CurrencyChart = dynamic(
  () => import("@/components/chart/CurrencyChart"),
  { ssr: false },
);
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData.error || "Failed to fetch data from the bridge API.",
        );
      }
          ...
          <Card className="data-card glow-multi-color">
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <div className="flex gap-4">
                ...
                >
                  <SelectTrigger className="w-[180px] bg-gray-800 border-cyan-400 text-white">
                    <SelectValue />
                  </SelectTrigger>
                  ...
                  <>
                    ...
                    {dataSource && (
                      <p className="text-xs text-center text-gray-500 mt-2">
                        Data served from: {dataSource}
                      </p>
                    )}
                  </>
                )}
                {loading && (
                  <div className="flex items-center justify-center h-full text-cyan-400 text-lg">
