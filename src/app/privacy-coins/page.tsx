    ...
    <>
      ...
      <main className="dashboard-grid">
        <section className="center-content">
          <h1 className="text-3xl font-bold neon-text text-center mt-8">Privacy-Focused Coins</h1>
          ...
          <div className="w-full overflow-x-auto mt-8">
            <div className="info-table-card">
              ...
              {filteredTokens.length === 0 && (
                <p className="text-center text-gray-400 py-8">No privacy coins found matching your search.</p>
              )}
            </div>
          </div>
        </section>
