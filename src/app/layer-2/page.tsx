      ...
      <main className="dashboard-grid">
        <section className="center-content">
          <h1 className="text-3xl font-bold neon-text text-center mt-8">
            Layer-2 Scaling Solutions Encyclopedia
          </h1>
          <p className="text-lg text-gray-300 text-center max-w-3xl mx-auto">
            A comprehensive, curated list of Layer-2 solutions across various
            blockchain ecosystems. Layer-2s are protocols built on top of
            base-layer blockchains (like Bitcoin or Ethereum) to provide faster
