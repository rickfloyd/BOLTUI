...
export const metaverseProjects: MetaverseProject[] = [
  ...
  { name: 'Mutant Ape Yacht Club', website: 'https://boredapeyachtclub.com#mutants' },
  ...
  { name: 'Bored Ape Kennel Club', website: 'https://boredapeyachtclub.com#kennel' },
  { name: 'Ringers (Art Blocks)', website: 'https://www.artblocks.io/project/4' },
  ...
  { name: 'Forgotten Runes Wizard’s Cult', website: 'https://forgottenrunes.com' },
