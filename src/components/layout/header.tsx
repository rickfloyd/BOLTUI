...
const republicanItems: DropdownItem[] = [
  ...
  { name: "RedState", type: "link", href: "https://redstate.com" },
  {
    ...
    type: "link",
    href: "https://www.washingtontimes.com",
  },
...
const watchlistItems: DropdownItem[] = [
  {
    name: "My Watchlist",
    subtext: "View and manage your watchlist",
    type: "link",
    href: "/watchlist",
  },
];
  ...
  return (
    <>
      <div className="header-top-layer">
        <div className="flex items-center gap-4">
          <div className="header-title leading-tight">
            <span className="neon-text">Quantum</span>
            <br />
            <span className="text-white">CyberVision</span>
          </div>
        </div>
        <div className="nav-right">
          <HeaderDropdown
            ...
            items={tradersProfileItems}
            titleClassName="neon-orange"
          />
          <Link
            href="#"
            className="nav-item neon-purple text-center leading-tight"
          >
            ASK
            <br />
            QUBIT
          ...
          <Link
            href="/forex"
            className="nav-item neon-cyan text-center leading-tight"
          >
            Forex
          </Link>
          <HeaderDropdown
      ...
      <div className="header-fifth-layer">
        <nav className="main-nav">{/* New row for bottom header links */}</nav>
      </div>
    </>
  );
}
      ...
      {isOpen && (
        <div className="mobile-menu">
          <nav className="mobile-nav-links">
            ...
            <Link href="/forex" className="nav-item neon-cyan">
              Forex
            </Link>
            <HeaderDropdown
              title="Community"
