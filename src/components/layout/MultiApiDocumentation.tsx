...
export function MultiApiDocumentation() {
  const dataFlowImage = PlaceHolderImages.find(
    (p) => p.id === "data-flow-diagram",
  );
  ...
  return (
    <div className="mt-12 p-8 rounded-lg bg-black/50 border-2 border-cyan-500/50 shadow-[0_0_25px_rgba(0,255,255,0.3)] w-full text-gray-300">
      ...
      <section className="mb-8">
        ...
        <p>
          The system now uses four different data sources to fetch stock prices
          throughout the trading day:
        </p>
        <ul className="list-disc list-inside mt-2 space-y-1 pl-4">
          <li>
            <strong>Alpha Vantage</strong> - Morning prices (9:00 AM EST /
            Market Open)
          </li>
          <li>
            <strong>Marketstack</strong> - Midday prices (12:00 PM EST)
          </li>
          <li>
            <strong>Polygon.io</strong> - Afternoon prices (3:00 PM EST)
          </li>
          <li>
            <strong>Averaged Data</strong> - Market close (4:00 PM EST) -
            averages data from all three APIs
          </li>
        </ul>
      </section>
  ...
  source TEXT  -- NEW: alphavantage, marketstack, polygon, or averaged
      ...
      <section className="mb-8">
        ...
        <p>
          A cron job at `GET /api/cron/fetch-rss` handles daily fetching, and
          the `GET /api/stocks` endpoint allows filtering by source.
        </p>
        <pre className="bg-gray-900/70 p-4 rounded-lg mt-2 border border-cyan-400/30 overflow-x-auto text-sm">
          <code>
...
`}
      ...
      <section className="mb-8">
        ...
        <p>
          At 4:00 PM EST (market close), the system fetches from all APIs in
          parallel, groups data by ticker, and calculates the average price,
          change, and change percentage, storing the result with
          `source="averaged"`.
        </p>
        <pre className="bg-gray-900/70 p-4 rounded-lg mt-2 border border-cyan-400/30 overflow-x-auto text-sm">
          <code>
