(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    var t = e.i(43476),
      s = e.i(71645),
      n = e.i(75157);
    let r = s.forwardRef(({ className: e, type: s, ...r }, i) =>
      (0, t.jsx)("input", {
        type: s,
        className: (0, n.cn)(
  ...
  (e, t, s) => {
    ...
    for (var r in n) Object.defineProperty(s, r, { enumerable: !0, get: n[r] });
    function i(e) {
      let t = {};
    ...
    function o(e) {
      ...
      for (let [s, n] of Object.entries(e))
        if (Array.isArray(n)) for (let e of n) t.append(s, a(e));
        else t.set(s, a(n));
      return t;
    }
    function l(e, ...t) {
      for (let s of t) {
        ...
        for (let [t, n] of s.entries()) e.append(t, n);
      }
      return e;
    }
  },
      ...
      return (0, n.useCallback)(
        (n) => {
          if (null === n) {
            ...
            let t = r.current;
            t && ((r.current = null), t());
          } else (e && (s.current = i(e, n)), t && (r.current = i(t, n)));
        },
        [e, t],
      );
    }
  ...
  (e, t, s) => {
    ...
    function x(t) {
      ...
      let R = o.default.useContext(c.AppRouterContext),
        ...
        F =
          !1 !== j
            ...
            : p.FetchStrategy.PPR,
        { href: B, as: _ } = o.default.useMemo(() => {
          let e = f(g);
          return { href: e, as: S ? f(S) : e };
        }, [g, S]);
      if (D) {
      ...
      let z = D ? r && "object" == typeof r && r.ref : I,
        X = o.default.useCallback(
          (e) => (
            null !== R &&
              (v.current = (0, h.mountLinkInstance)(e, B, R, F, U, x)),
            () => {
              (v.current &&
        ...
        G = {
          ref: (0, u.useMergedRef)(X, z),
          onClick(t) {
            (D || "function" != typeof P || P(t),
              D &&
                r.props &&
                ...
                (function (t, s, n, r, i, a, l) {
                  if ("undefined" != typeof window) {
                    ...
                    if (
                      ...
                      return;
                    if (!(0, y.isLocalURL)(s)) {
                      i && (t.preventDefault(), location.replace(s));
                      return;
                    }
                    ...
                    o.default.startTransition(() => {
                      m(n || s, i ? "replace" : "push", a ?? !0, r.current);
                    });
                  }
                })(t, B, _, v, A, C, O));
          },
          onMouseEnter(e) {
            (D || "function" != typeof E || E(e),
              D &&
                r.props &&
                "function" == typeof r.props.onMouseEnter &&
                r.props.onMouseEnter(e),
              R && U && (0, h.onNavigationIntent)(e.currentTarget, !0 === w));
          },
      ...
      return (
        (0, m.isAbsoluteUrl)(_)
          ? (G.href = _)
          : (D && !k && ("a" !== r.type || "href" in r.props)) ||
            (G.href = (0, d.addBasePath)(_)),
        (i = D
          ? o.default.cloneElement(r, G)
          : (0, a.jsx)("a", { ...L, ...G, children: n })),
  ...
  (e) => {
    ...
    let o = [
      ...
      {
        name: "UMA synthetic USD",
        symbol: "UMAUSD",
        issuer: "UMA / UMA token",
      },
      {
        name: "UMA token",
        symbol: "UMA",
      ...
      {
        name: "Frax synthetic assets",
        symbol: "FRAX",
        issuer: "Frax ecosystem",
      },
      ...
      let [e, l] = (0, s.useState)(""),
        c = o.filter(
          (t) =>
            ...
            t.issuer.toLowerCase().includes(e.toLowerCase()),
        );
      return (0, t.jsxs)(t.Fragment, {
        children: [
          (0, t.jsx)(n.Header, {}),
            ...
            children: (0, t.jsxs)("section", {
              ...
              children: [
                (0, t.jsx)("h1", {
                  ...
                  children: "Synthetic Asset Tokens",
                }),
                (0, t.jsx)("p", {
                  className:
                    "text-lg text-gray-300 text-center max-w-3xl mx-auto",
                  children:
                    "A curated list of synthetic assets, protocols, and governance tokens. Synthetics mirror the value of other assets, enabling exposure without ownership.",
                }),
                (0, t.jsx)("div", {
          ...
          (0, t.jsxs)(i.default, {
            ...
            children: [(0, t.jsx)(a.ArrowLeft, { size: 16 }), "Back"],
          }),
        ],
      });
    }
