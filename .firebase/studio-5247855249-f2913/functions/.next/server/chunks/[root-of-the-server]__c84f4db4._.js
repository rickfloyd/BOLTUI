module.exports = [
  ...
  (e, t, r) => {
    "use strict";
    t.exports = e.r(42315).vendored["react-rsc"].ReactServerDOMTurbopackServer;
  },
  45015,
  (e, t, r) => {
    "use strict";
...
Read more: https://nextjs.org/docs/messages/invalid-use-server-value`),
    ...
    (Object.defineProperty(r, "__esModule", { value: !0 }),
      Object.defineProperty(r, "ensureServerEntryExports", {
        enumerable: !0,
        get: function () {
          return a;
        },
  ...
  (e) => {
    ...
    let y = (e) =>
        e.values
          ? e.values
              .map((e) => ({
                ...
                volume: void 0 !== e.volume ? parseFloat(e.volume) : null,
              }))
              .reverse()
          : [],
      b = (e) =>
        e.t
          ? e.t.map((t, r) => ({
              time: new Date(1e3 * t).toISOString(),
              open: e.o[r],
              high: e.h[r],
              low: e.l[r],
              close: e.c[r],
      ...
      T = async (e, t, r, a, n) => {
        try {
          let o = process.env.NEXT_PUBLIC_BASE_URL || "http://localhost:3000",
            s = new URL(`${o}${e}`);
          (s.searchParams.set("symbol", a), s.searchParams.set("interval", n));
          let i = await fetch(s.toString(), { cache: "no-store" });
          if (!i.ok) {
            let e = await i.text();
            throw Error(
              `Failed to fetch from ${r}: ${i.status} ${i.statusText} - ${e}`,
            );
          }
          let l = await i.json();
          if (l.error) throw Error(`${r} API error: ${l.error}`);
          let u = t(l);
          if (0 === u.length) throw Error(`${r} returned no data.`);
          return { data: u, source: r };
        } catch (e) {
          throw (
            console.warn(`Could not fetch from ${r}:`, e.message),
            { provider: r, reason: e.message }
          );
        }
      };
    async function A(e) {
      let t,
        ...
        l = i.get("symbol") || "BTC/USD",
        u = i.get("interval") || "1h",
        d = ((t = "BINANCE:BTCUSDT"),
        (r = "60"),
        "ETH/USD" === l && (t = "BINANCE:ETHUSDT"),
        "1min" === u ? (r = "1") : "1day" === u && (r = "D"),
        (a = "X:BTCUSD"),
        (n = "hour"),
        "ETH/USD" === l && (a = "X:ETHUSD"),
        "1min" === u ? (n = "minute") : "1day" === u && (n = "day"),
        (o = "BTCUSD"),
        (s = "1hour"),
        "ETH/USD" === l && (o = "ETHUSD"),
        "1min" === u ? (s = "1min") : "1day" === u && (s = "24hour"),
        [
          {
            name: "MarketStack",
            apiUrl: "/api/marketstack",
            normalizer: C,
            symbol: o,
            interval: s,
          },
        ...
        ]).map((e) => T(e.apiUrl, e.normalizer, e.name, e.symbol, e.interval)),
        p = await Promise.allSettled(d);
      for (let e of p)
        if ("fulfilled" === e.status)
          return (
            console.log(`Successfully fetched data from ${e.value.source}`),
            E.NextResponse.json(e.value)
          );
      let c = p.filter((e) => "rejected" === e.status).map((e) => e.reason);
      return (
        console.error("All data providers failed:", c),
        E.NextResponse.json(
          { error: "All data providers failed to return data.", details: c },
          { status: 502 },
        )
      );
    }
    ((0, w.ensureServerEntryExports)([A]),
      (0, x.registerServerReference)(
        A,
        "402a7fe654238bb5aaf701a04ec48f7cfa865933c7",
        null,
      ),
      e.s(["GET", () => A], 12919));
    var U = e.i(12919);
    let P = new t.AppRouteRouteModule({
      ...
      { workAsyncStorage: N, workUnitAsyncStorage: O, serverHooks: _ } = P;
    function D() {
    ...
    async function j(e, t, a) {
      ...
      let x = "/api/bridge/route";
      x = x.replace(/\/index$/, "") || "/";
      let E = await P.prepare(e, t, { srcPage: x, multiZoneDraftMode: !1 });
      if (!E)
        return (
          (t.statusCode = 400),
          t.end("Bad Request"),
      ...
      let {
        ...
        k = !!(T.dynamicRoutes[j] || T.routes[O]),
        H = async () => (
          (null == A ? void 0 : A.render404)
            ? await A.render404(e, t, S, !1)
        ...
        L = {
          ...
          renderOpts: {
            ...
            onInstrumentationRequestError: (t, r, a) =>
              P.onRequestError(e, t, a, A),
          },
          sharedContext: { buildId: w },
        },
        K = new u.NodeNextRequest(e),
        X = new u.NodeNextResponse(t),
      ...
      try {
        let s = async (e) =>
          ...
          l = async (n) => {
            ...
            return (
              (i && k) || p.delete(f.NEXT_CACHE_TAGS_HEADER),
              !d.cacheControl ||
        ...
        if (
          ...
          throw t;
        return (
          await (0, h.sendResponse)(K, X, new Response(null, { status: 500 })),
          null
        );
      }
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c84f4db4._.js.map
