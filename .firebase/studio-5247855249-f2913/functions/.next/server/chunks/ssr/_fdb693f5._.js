  ...
  (a) => {
    ...
    let I = [
      ...
      K = new d.AppPageRouteModule({
        definition: {
          ...
          page: "/wrapped-assets/page",
          pathname: "/wrapped-assets",
          bundlePath: "",
          filename: "",
          appPaths: [],
        },
    ...
    async function L(a, b, c) {
      ...
      let {
        ...
        av =
          (!al || !ap) &&
          (!aj || (0, p.shouldServeStreamingMetadata)(aj, ac.htmlLimitedBots)),
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
    ...
    (a.s(["__next_app__", 0, J, "handler", () => L, "routeModule", 0, K], 9671),
      a.i(9671),
      a.s(
        [
          "ClientPageRoot",
...
//# sourceMappingURL=_fdb693f5._.js.map
