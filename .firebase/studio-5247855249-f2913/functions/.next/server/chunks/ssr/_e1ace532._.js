      ...
      return (
        (0, c.useEffect)(() => {
          (async () => {
            try {
              o(!0);
              let a = i[Math.floor(Date.now() / 1728e5) % i.length],
                b = await fetch("/api/coingecko/coins");
              if (!b.ok) throw Error("Failed to fetch token list from API.");
              let c = await b.json(),
                d = c.find((b) => b.id === a.id);
              if (d) m(d);
              else {
                let a = c.find((a) => "hamster" === a.id);
                m(a);
              }
            } catch (a) {
              (console.error("Failed to fetch featured token:", a), m(null));
            } finally {
              o(!1);
            }
          })();
            ...
            (0, b.jsx)("main", {
              ...
              children: (0, b.jsxs)("section", {
                ...
                children: [
                  ...
                  (0, b.jsx)("div", {
                    ...
                    children: h.map((c, d) =>
                      (0, b.jsxs)(
                        "button",
                        {
                          className: `data-card ${c.color} ${c.className || "font-cinzel"} flex flex-col justify-start text-left`,
                          onClick: () =>
                            ((b) => {
                              if (b.route) a.push(b.route);
                              else {
                                let c = b.name.toLowerCase().replace(/ /g, "-");
                                a.push(`/charts/${c}`);
                              }
                            })(c),
                          children: [
                  ...
                  (0, b.jsx)("div", {
                    className: "mt-12",
                    children: (0, b.jsxs)(g.Card, {
                      className: "info-table-card",
                      children: [
                        (0, b.jsx)(g.CardHeader, {
                          children: (0, b.jsx)(g.CardTitle, {
                            className: "text-2xl neon-text",
                            children: n
                              ? "Loading Featured Token..."
                              : `Featured Token: ${l?.name || "N/A"} (${l?.symbol?.toUpperCase() || "N/A"})`,
                          }),
                        }),
                                          ...
                                          children: [
                                            ...
                                            (0, b.jsxs)("tr", {
                                              children: [
                                                ...
                                                (0, b.jsx)("td", {
                                                  children: (0, b.jsx)("a", {
                                                    href: `https://www.coingecko.com/en/coins/${l.id}`,
                                                    target: "_blank",
                                            ...
                                            (0, b.jsxs)("tr", {
                                              children: [
                                                ...
                                                (0, b.jsx)("td", {
                                                  children: (0, b.jsx)("a", {
                                                    href: `https://coinmarketcap.com/currencies/${l.id}/`,
                                                    target: "_blank",
                                                    rel: "noopener noreferrer",
                                                    className:
                                                      "text-cyan-400 hover:underline",
...
//# sourceMappingURL=_e1ace532._.js.map
