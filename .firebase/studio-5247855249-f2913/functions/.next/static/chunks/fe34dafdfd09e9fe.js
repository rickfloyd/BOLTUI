  ...
  (e, t, n) => {
    ...
    function y(t) {
      ...
      let r,
        a,
        s,
        [o, y] = (0, l.useOptimistic)(h.IDLE_LINK_STATUS),
        v = (0, l.useRef)(null),
        {
          href: g,
          as: j,
      ...
      let B = E ? a && "object" == typeof a && a.ref : M,
        V = l.default.useCallback(
          (e) => (
            null !== R &&
              (v.current = (0, h.mountLinkInstance)(e, D, R, $, F, y)),
            () => {
              (v.current &&
        ...
        z = {
          ref: (0, u.useMergedRef)(V, B),
          onClick(t) {
            (E || "function" != typeof A || A(t),
              E &&
                a.props &&
          ...
          onMouseEnter(e) {
            (E || "function" != typeof P || P(e),
              ...
              R && F && (0, h.onNavigationIntent)(e.currentTarget, !0 === I));
          },
    ...
    function c() {
      ...
      (0, n.useEffect)(() => {
        let e = async () => {
          try {
            h(!0);
            let e = await fetch("/api/coingecko/coins");
            if (!e.ok) {
              let t = await e.json();
              throw Error(t.error || "Failed to fetch Proof of Work coins.");
            }
            let t = (await e.json())
              .filter((e) => l.includes(e.symbol.toLowerCase()))
              .map((e) => {
                let t = o.get(e.symbol.toLowerCase());
                return {
                  ...e,
                  ath_price_2025: t?.ath_price_2025,
                  ath_date_2025: t?.ath_date_2025,
                };
              });
            (d(t), p(null));
          } catch (e) {
                          ...
                          children: [
                            (0, t.jsx)("thead", {
                              children: (0, t.jsxs)("tr", {
                                children: [
                                  (0, t.jsx)("th", { children: "Rank" }),
                                  (0, t.jsx)("th", { children: "Coin" }),
                                  (0, t.jsx)("th", { children: "Symbol" }),
                                  (0, t.jsx)("th", { children: "Price" }),
                                  (0, t.jsx)("th", { children: "Market Cap" }),
                                  (0, t.jsx)("th", {
                                    children: "2025 ATH Price",
                                  }),
                                  (0, t.jsx)("th", { children: "ATH Date" }),
                                  (0, t.jsx)("th", {
                                  ...
                                  "tr",
                                  {
                                    ...
                                    children: [
                                      ...
                                      (0, t.jsx)("td", {
                                        ...
                                        children: e.ath_price_2025 || "N/A",
                                      }),
                                      (0, t.jsx)("td", {
                                        className: "text-gray-400",
                                        children: e.ath_date_2025 || "N/A",
                                      }),
                                      (0, t.jsx)("td", {
                                        children: (0, t.jsx)(s.default, {
                                          href: `https://www.coingecko.com/en/coins/${e.id}`,
                                          target: "_blank",
                                          rel: "noopener noreferrer",
                                          className:
