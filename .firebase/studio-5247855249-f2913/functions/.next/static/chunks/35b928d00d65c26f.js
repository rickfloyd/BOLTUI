(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, n) => {
    ...
    function y(t) {
      ...
      let F = l.default.useContext(c.AppRouterContext),
        D = !1 !== k,
        _ =
          !1 !== k
            ? null === (n = k) || "auto" === n
      ...
      let $ = T ? a && "object" == typeof a && a.ref : I,
        W = l.default.useCallback(
          (e) => (
            null !== F &&
              (g.current = (0, f.mountLinkInstance)(e, B, F, _, D, y)),
            () => {
              (g.current &&
        ...
        z = {
          ...
          onMouseEnter(e) {
            (T || "function" != typeof w || w(e),
              ...
              F && D && (0, f.onNavigationIntent)(e.currentTarget, !0 === L));
          },
      ...
      return (
        (0, d.isAbsoluteUrl)(U)
          ...
          : (T && !A && ("a" !== a.type || "href" in a.props)) ||
            (z.href = (0, m.addBasePath)(U)),
        (s = T
          ? l.default.cloneElement(a, z)
          : (0, i.jsx)("a", { ...M, ...z, children: r })),
        (0, i.jsx)(b.Provider, { value: o, children: s })
      );
    }
    e.r(84508);
  ...
  (e) => {
    ...
    let l = [
      ...
      { name: "Switchboard", symbol: "SWTCH" },
      { name: "iExec RLC", symbol: "RLC" },
      { name: "Nest Protocol", symbol: "NEST" },
      { name: "Oraichain", symbol: "ORAI" },
      { name: "XYO Network", symbol: "XYO" },
      { name: "Chainflip", symbol: "FLIP" },
      { name: "Apro", symbol: "AT" },
      { name: "SupraOracles", symbol: "SUPRA" },
      { name: "Phala Network", symbol: "PHA" },
      { name: "WINkLink", symbol: "WIN" },
      { name: "Orao Network", symbol: "ORAO" },
      { name: "Mars Protocol", symbol: "MARS (example)" },
      { name: "Razor Network", symbol: "RAZOR" },
      { name: "Witnet", symbol: "WIT" },
      { name: "Bellatrix", symbol: "BELL (placeholder)" },
      { name: "OracleChain (legacy)", symbol: "OCT" },
      { name: "Augur", symbol: "REP" },
      { name: "Umbrella Network", symbol: "UMB" },
      { name: "Kylin Network", symbol: "KYL" },
      { name: "Berry Data", symbol: "BRY" },
      { name: "DOS Network", symbol: "DOS" },
      { name: "Entangle", symbol: "NTGL" },
      { name: "Apiary", symbol: "APIARY (placeholder)" },
      { name: "Xensor", symbol: "XSR (placeholder)" },
      { name: "Li.Fi", symbol: "LIFI" },
    ];
    function o() {
            ...
            children: (0, t.jsxs)("section", {
              ...
              children: [
                (0, t.jsx)("h1", {
                  ...
                  children: "Oracle Tokens",
                }),
                (0, t.jsx)("p", {
                  className:
                    "text-lg text-gray-300 text-center max-w-3xl mx-auto",
                  children:
                    "A curated list of projects and tokens that provide oracle services, delivering real-world data to blockchain smart contracts.",
                }),
                (0, t.jsx)("div", {
                ...
                (0, t.jsxs)("div", {
                  ...
                  children: [
                    (0, t.jsx)("h3", {
                      ...
                      children: "Notes on the Oracle Ecosystem:",
                    }),
                    (0, t.jsxs)("ul", {
                      ...
                      children: [
                        (0, t.jsxs)("li", {
                          children: [
                            ...
                            (0, t.jsx)("strong", {
                              children: "(A) native oracle tokens",
                            }),
                            " (Chainlink, Pyth, Band, API3, Tellor, DIA, Switchboard), ",
                            (0, t.jsx)("strong", {
                              children:
                                "(B) data-aggregation and middleware projects",
                            }),
                            " that provide oracle-like services (RedStone, Supra, RedStone Streams, Umbrella, Witnet), and ",
                            (0, t.jsx)("strong", {
                              children: "(C) on-chain systems or protocols",
                            }),
                            " that embed oracle functionality or use oracle tokens for staking and validation (iExec, Phala, Kylin, Razor).",
                          ],
                        }),
                        (0, t.jsx)("li", {
                          children:
                            "Several projects have multiple tokens, ecosystem variants, or no single canonical token (some oracle services are protocols without a utility token). Coin tickers and token names can change, new oracle projects appear, and some legacy or specialized oracle tokens are region- or chain-specific.",
                        }),
                      ],
                    }),
                  ],
