(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    function x(e, t, r) {
      let n =
        ...
        (e === E.FetchStrategy.Full || e === E.FetchStrategy.PPRRuntime);
    ...
    function U(e, t, r) {
      null !== t.onInvalidate && (null === O ? (O = new Set([t])) : O.add(t));
      let n = A(e, r);
      if (null !== n) return n;
      let l = {
          canonicalUrl: null,
      ...
      try {
        ...
        if (j) {
          ...
          let o = (0, h.getRenderedPathname)(r),
              ...
              (function e(t, r, n, l, a, o, i) {
                ...
                if (null !== s)
                  for (let t in ((c = {}), s)) {
                    ...
                    let _ = r ? i + 1 : i,
                      R = (0, y.createSegmentRequestKeyPart)(n),
                      P = (0, y.appendSegmentRequestKeyPart)(l, t, R),
                      E = (0, y.appendSegmentCacheKeyPart)(
                        a,
                        t,
                        (0, y.createSegmentCacheKeyPart)(R, n),
                      );
                    c[t] = e(u, n, g, P, E, o, _);
                  }
                return {
            ...
            g = S(a.staleTime);
          q(e, f, a.head, a.isHeadPartial, Date.now() + g, T, R, d, j, !1);
        } else {
          ...
          !(function (e, t, r, n, l, a, i, c, s) {
            ...
            if ("string" == typeof f || 1 !== f.length) return W(a, e + 1e4);
            let p = f[0];
            if (!p.isRootRender) return W(a, e + 1e4);
            let R = p.tree,
              E = n.headers.get(o.NEXT_ROUTER_STALE_TIME_HEADER),
              m = null !== E ? S(parseInt(E, 10)) : _.STATIC_STALETIME_MS,
              ...
              b = q(
                ...
                (function e(t, r, n) {
                  ...
                  for (let t in o) {
                    let l = o[t],
                      u = l[0],
                      i = (0, y.createSegmentRequestKeyPart)(u),
                      ...
                      s = e(
                        ...
                        (0, y.appendSegmentCacheKeyPart)(
                          r,
                          t,
                          (0, y.createSegmentCacheKeyPart)(i, u),
                        ),
                        c,
                      );
                    null === a ? (a = { [t]: s }) : (a[t] = s);
                ...
                })(R, y.ROOT_SEGMENT_CACHE_KEY, y.ROOT_SEGMENT_REQUEST_KEY),
                p.head,
                p.isHeadPartial,
                e + m,
                i,
          ...
          })(Date.now(), t, E.FetchStrategy.LoadingBoundary, r, l, e, T, R, j);
        }
        if (!T) {
    ...
    function Z(e, t, r, n, l, a, u, i) {
      ...
      let d = n.headers.get(o.NEXT_ROUTER_STALE_TIME_HEADER),
        f = e + (null !== d ? S(parseInt(d, 10)) : _.STATIC_STALETIME_MS);
      for (let n of c) {
        let l = n.seedData;
        if (null !== l) {
          let o = n.segmentPath,
  ...
  (e, t, r) => {
    ...
    function s(e, t, r, n, l, a, i) {
      ...
      return (
        void 0 === i.collectedDebugInfo && (R = i.collectedDebugInfo = []),
        {
  ...
  (e, t, r) => {
    ...
    function c(e, t, r, n, l) {
      ...
      for (let t = 0; t < c.length; t += 2) {
        ...
        (R && R !== _) || ((R = new Map(_)), h.parallelRoutes.set(r, R));
        let P = _.get(g),
          E = R.get(g);
        if (y) {
          if (s && (!E || !E.lazyData || E === P)) {
            ...
            ((E = {
              ...
              P && l && (0, a.invalidateCacheByRouterState)(E, P, d),
              l && (0, u.fillLazyItemsTillLeafWithHead)(e, E, P, d, s, f),
              R.set(g, E));
          }
          continue;
        }
          ...
          for (let r of ((R.lazyData = null), n)) {
            ...
            if (((y.canonicalUrl = (0, l.createHrefFromUrl)(s)), null !== i)) {
              ...
              ((R.rsc = t),
                (R.prefetchRsc = null),
                (R.loading = r),
                (0, c.fillLazyItemsTillLeafWithHead)(E, R, void 0, n, i, m),
        ...
        async ({
          ...
          if (
            (_ &&
              ...
              (l.canonicalUrl = j = (0, s.createHrefFromUrl)(_, !1))),
            !c)
          )
            return (r(i), _)
              ? (0, d.handleExternalUrl)(e, l, _.href, e.pushRef.pendingPush)
              : e;
          if ("string" == typeof c)
            return (
              r(i),
          ...
          for (let n of (w && (t.didRevalidate = !0), c)) {
            let { tree: c, seedData: s, head: p, isRootRender: _ } = n;
            if (!_) return (console.log("SERVER ACTION APPLY FAILED"), r(i), e);
            ...
            if (null === E)
              return (r(i), (0, R.handleSegmentMismatch)(e, t, c));
