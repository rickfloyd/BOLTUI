(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, n) => {
    ...
    function y(t) {
      ...
      let X = w ? a && "object" == typeof a && a.ref : R,
        V = l.default.useCallback(
          (e) => (
            null !== F &&
              (j.current = (0, f.mountLinkInstance)(e, B, F, _, D, y)),
            () => {
              (j.current &&
        ...
        $ = {
          ...
          onMouseEnter(e) {
            (w || "function" != typeof T || T(e),
              ...
              F && D && (0, f.onNavigationIntent)(e.currentTarget, !0 === I));
          },
      ...
      return (
        (0, m.isAbsoluteUrl)(U)
          ? ($.href = U)
          : (w && !A && ("a" !== a.type || "href" in a.props)) ||
            ($.href = (0, d.addBasePath)(U)),
        (s = w
          ? l.default.cloneElement(a, $)
          : (0, i.jsx)("a", { ...L, ...$, children: r })),
