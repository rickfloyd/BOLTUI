(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    var t = e.i(43476),
      n = e.i(71645),
      s = e.i(75157);
    let r = n.forwardRef(({ className: e, type: n, ...r }, a) =>
      (0, t.jsx)("input", {
        type: n,
        className: (0, s.cn)(
  ...
  (e, t, n) => {
    ...
    for (var r in s) Object.defineProperty(n, r, { enumerable: !0, get: s[r] });
    function a(e) {
      let t = {};
    ...
    function o(e) {
      ...
      for (let [n, s] of Object.entries(e))
        if (Array.isArray(s)) for (let e of s) t.append(n, i(e));
        else t.set(n, i(s));
      return t;
    }
    function l(e, ...t) {
      ...
      return (0, s.useCallback)(
        (s) => {
          if (null === s) {
            ...
            let t = r.current;
            t && ((r.current = null), t());
          } else (e && (n.current = a(e, s)), t && (r.current = a(t, s)));
        },
        [e, t],
      );
    }
    ...
    async function p(e, t) {
      ...
      if (!s)
        throw Object.defineProperty(
          Error(
            `"${u(e)}.getInitialProps()" should resolve to an object. But found "${s}" instead.`,
          ),
          "__NEXT_ERROR_CODE",
  ...
  (e, t, n) => {
    ...
    function x(t) {
      ...
      let s,
        r,
        a,
        [l, x] = (0, o.useOptimistic)(h.IDLE_LINK_STATUS),
        g = (0, o.useRef)(null),
        {
          href: j,
          as: v,
      ...
      if (M) {
        ...
        r = o.default.Children.only(s);
      }
      let U = M ? r && "object" == typeof r && r.ref : L,
        X = o.default.useCallback(
          (e) => (
            null !== F &&
              (g.current = (0, h.mountLinkInstance)(e, B, F, _, D, x)),
            () => {
              (g.current &&
        ...
        $ = {
                ...
                (function (t, n, s, r, a, i, l) {
                  if ("undefined" != typeof window) {
                    ...
                    o.default.startTransition(() => {
                      u(s || n, a ? "replace" : "push", i ?? !0, r.current);
                    });
                  }
                })(t, B, G, g, A, S, T));
          },
          onMouseEnter(e) {
            (M || "function" != typeof O || O(e),
              ...
              F && D && (0, h.onNavigationIntent)(e.currentTarget, !0 === I));
          },
      ...
      return (
        (0, u.isAbsoluteUrl)(G)
          ? ($.href = G)
          : (M && !k && ("a" !== r.type || "href" in r.props)) ||
            ($.href = (0, d.addBasePath)(G)),
        (a = M
          ? o.default.cloneElement(r, $)
          : (0, i.jsx)("a", { ...R, ...$, children: s })),
        (0, i.jsx)(y.Provider, { value: l, children: a })
      );
    }
    e.r(84508);
  ...
  (e) => {
    ...
    var t = e.i(43476),
      n = e.i(22016),
      s = e.i(71645);
    function r({ title: e, items: r, titleClassName: a }) {
      let [i, o] = (0, s.useState)(!1);
      return (0, t.jsxs)("div", {
  ...
  (e) => {
    ...
    let l = [
      ...
      { name: "FLOKI", symbol: "FLOKI", website: "https://www.floki.com" },
      {
        name: "The Sandbox",
        symbol: "SAND",
        website: "https://www.sandbox.game",
      },
      { name: "Gala Games", symbol: "GALA", website: "https://gala.games" },
      {
        name: "Decentraland",
        symbol: "MANA",
        website: "https://decentraland.org",
      },
      { name: "ApeCoin", symbol: "APE", website: "https://apecoin.com" },
      { name: "WEMIX", symbol: "WEMIX", website: "https://wemix.com" },
      {
        name: "Axie Infinity",
        symbol: "AXS",
        website: "https://axieinfinity.com",
      },
      { name: "Ronin", symbol: "RON", website: "https://roninchain.com" },
      { name: "Illuvium", symbol: "ILV", website: "https://illuvium.io" },
      { name: "Enjin Coin", symbol: "ENJ", website: "https://enjin.io" },
      { name: "Wax", symbol: "WAXP", website: "https://wax.io" },
      {
        name: "MyNeighborAlice",
        symbol: "ALICE",
        website: "https://myneighboralice.com",
      },
      {
      ...
      { name: "Star Atlas", symbol: "ATLAS", website: "https://staratlas.com" },
      {
        name: "X World Games",
        symbol: "XWG",
        website: "https://xworldgames.com",
      },
      { name: "Chromia", symbol: "CHR", website: "https://chromia.com" },
      { name: "Ultra", symbol: "UOS", website: "https://ultra.io" },
      { name: "Metahero", symbol: "HERO", website: "https://metahero.io" },
      { name: "PlayDapp", symbol: "PLA", website: "https://playdapp.io" },
      {
        name: "Alien Worlds",
        symbol: "TLM",
        website: "https://alienworlds.io",
      },
      { name: "GameFi.org", symbol: "GAFI", website: "https://gamefi.org" },
      {
        name: "Gods Unchained",
        symbol: "GODS",
      ...
      { name: "Mobox", symbol: "MBOX", website: "https://mobox.io" },
      {
        name: "Animoca Brands",
        symbol: "ANIM",
      ...
      { name: "Faraland", symbol: "FARA", website: "https://faraland.io" },
      { name: "Merit Circle", symbol: "MC", website: "https://meritcircle.io" },
      { name: "SuperFarm", symbol: "SUPER", website: "https://superfarm.com" },
      { name: "Pegaxy", symbol: "PGX", website: "https://pegaxy.io" },
      {
        name: "Vulcan Forged",
        symbol: "PYR",
      ...
      },
      {
        ...
        symbol: "MCH",
        website: "https://mycryptoheroes.net",
      },
      {
      ...
      {
        name: "Axie Smooth Love Potion",
        symbol: "SLP",
        website: "https://axieinfinity.com",
      },
      { name: "Oasys", symbol: "OAS", website: "https://oasys.games" },
      {
      ...
      { name: "Upland", symbol: "UPLAND", website: "https://upland.me" },
      {
        name: "CryptoKitties",
        symbol: "CK",
      ...
      },
      {
        name: "Yield Hunters",
        symbol: "YH",
        website: "https://yieldhunters.com",
      },
      {
        name: "Bomb Crypto",
        symbol: "BCOIN",
      ...
      { name: "Blocklords", symbol: "BLT", website: "https://blocklords.com" },
      {
        name: "ChainGuardians",
        symbol: "CGG",
                    ...
                    children: [
                      ...
                      0 === m.length &&
                        (0, t.jsx)("p", {
                          ...
                          children:
                            "No gaming tokens found matching your search.",
                        }),
                    ],
                  }),
                }),
                (0, t.jsxs)("div", {
                  ...
                  children: [
                    (0, t.jsx)("h3", {
                      ...
                      children: "Notes on the GameFi Ecosystem:",
                    }),
                    (0, t.jsx)("p", {
                      children:
