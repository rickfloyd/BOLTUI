    ...
    function y(t) {
      ...
      let $ = T ? a && "object" == typeof a && a.ref : M,
        V = o.default.useCallback(
          (e) => (
            null !== I &&
              (b.current = (0, m.mountLinkInstance)(e, B, I, D, L, y)),
            () => {
              (b.current &&
        ...
        W = {
          ...
          onMouseEnter(e) {
            (T || "function" != typeof E || E(e),
              ...
              I && L && (0, m.onNavigationIntent)(e.currentTarget, !0 === _));
          },
      ...
      return (
        (0, d.isAbsoluteUrl)(U)
          ...
          : (T && !C && ("a" !== a.type || "href" in a.props)) ||
            (W.href = (0, f.addBasePath)(U)),
        (s = T
          ? o.default.cloneElement(a, W)
          : (0, i.jsx)("a", { ...F, ...W, children: r })),
        ...
        f = (e) => {
          switch ((c(!1), e.code)) {
            ...
            case 2:
              ...
              break;
            case 3:
              o("The location request timed out.");
              break;
            default:
              o("An unknown error occurred while getting your location.");
          }
        },
        m = async (e, t) => {
          try {
            let n = await fetch(`/api/places?lat=${e}&lon=${t}`);
            if (!n.ok) {
              let e = await n.json();
              throw Error(e.error || "Failed to fetch restaurant data.");
            }
            let r = await n.json();
            s(r.results);
          } catch (e) {
              ...
              children: [
                ...
                (0, t.jsx)("div", {
                  ...
                  children: (0, t.jsx)(a.Button, {
                      ...
                      navigator.geolocation
                        ? (c(!0),
                          ...
                          navigator.geolocation.getCurrentPosition((e) => {
                            let { latitude: t, longitude: n } = e.coords;
                            (d({ lat: t, lon: n }), m(t, n));
                          }, f))
                        : o("Geolocation is not supported by your browser.");
                    },
                    disabled: l,
                    className:
                    ...
                    children: l ? "Searching..." : "Find Food Near Me",
                  }),
                }),
                (0, t.jsxs)("div", {
                                ...
                                "li",
                                {
                                  ...
                                  children: [
                                    ...
                                    (0, t.jsx)("p", {
                                      ...
                                      children:
                                        e.vicinity || "Location not available",
                                    }),
                                    (0, t.jsxs)("p", {
