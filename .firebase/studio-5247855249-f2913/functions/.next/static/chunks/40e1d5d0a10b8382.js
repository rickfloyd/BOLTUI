(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, n) => {
    ...
    function y(t) {
      ...
      let _ = l.default.useContext(c.AppRouterContext),
        L = !1 !== C,
        D =
          !1 !== C
            ? null === (n = C) || "auto" === n
      ...
      let $ = T ? a && "object" == typeof a && a.ref : M,
        V = l.default.useCallback(
          (e) => (
            null !== _ &&
              (g.current = (0, f.mountLinkInstance)(e, U, _, D, L, y)),
            () => {
              (g.current &&
        ...
        G = {
          ...
          onMouseEnter(e) {
            (T || "function" != typeof O || O(e),
              ...
              _ && L && (0, f.onNavigationIntent)(e.currentTarget, !0 === F));
          },
    ...
    e.r(84508);
    let j = (0, l.createContext)(f.IDLE_LINK_STATUS),
      g = () => (0, l.useContext)(j);
    ("function" == typeof n.default ||
      ("object" == typeof n.default && null !== n.default)) &&
      void 0 === n.default.__esModule &&
        ...
        (0, n.useEffect)(() => {
          (async () => {
            try {
              ...
              if (!e.ok) throw Error("Failed to fetch exchange rate data.");
              let t = await e.json();
              (i(t), u(null));
            } catch (e) {
              (u(e.message), i(null));
                              ...
                              (0, t.jsxs)("div", {
                                children: [
                                  (0, t.jsx)("p", {
                                    ...
                                    children: e.exchange_rates.EUR.toFixed(4),
                                  }),
                                  (0, t.jsxs)("p", {
                                    ...
                                    children: [
                                      ...
                                      e.base,
                                      " = ",
                                      e.exchange_rates.EUR.toFixed(4),
                                      " EUR",
                                    ],
                                  }),
                                ],
