(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
    ...
    async function h(e, t) {
      ...
      if (!r)
        throw Object.defineProperty(
          Error(
            `"${m(e)}.getInitialProps()" should resolve to an object. But found "${r}" instead.`,
          ),
          "__NEXT_ERROR_CODE",
  ...
  (e, t, n) => {
    ...
    function x(t) {
      ...
      let V = E ? a && "object" == typeof a && a.ref : R,
        $ = o.default.useCallback(
          (e) => (
            null !== I &&
              (g.current = (0, f.mountLinkInstance)(e, _, I, D, B, x)),
            () => {
              (g.current &&
        ...
        H = {
                ...
                (function (t, n, r, a, s, i, l) {
                  if ("undefined" != typeof window) {
                    ...
                    o.default.startTransition(() => {
                      m(r || n, s ? "replace" : "push", i ?? !0, a.current);
                    });
                  }
                })(t, _, U, g, S, P, w));
          },
          onMouseEnter(e) {
            (E || "function" != typeof L || L(e),
              ...
              I && B && (0, f.onNavigationIntent)(e.currentTarget, !0 === M));
          },
      ...
      return (
        ...
        (s = E
          ...
          : (0, i.jsx)("a", { ...F, ...H, children: r })),
        (0, i.jsx)(b.Provider, { value: l, children: s })
      );
    }
    e.r(84508);
    let b = (0, o.createContext)(f.IDLE_LINK_STATUS),
      g = () => (0, o.useContext)(b);
    ("function" == typeof n.default ||
      ("object" == typeof n.default && null !== n.default)) &&
      void 0 === n.default.__esModule &&
                  ...
                  children: c.map((e) =>
                    (0, t.jsxs)(
                      "div",
                      {
                        ...
                        children: [
                          (0, t.jsx)("h2", {
                            className: `text-2xl font-bold mb-4 ${e.color}`,
                            children: e.title,
                          }),
                          (0, t.jsxs)("table", {
