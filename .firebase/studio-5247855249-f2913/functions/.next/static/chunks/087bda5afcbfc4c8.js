(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
          ...
          if (
            ...
            if (Array.isArray(n)) {
              ...
              for (let e = 0, i = n.length; e < i; e++)
                n[e].isDataTexture ? t.push(_(n[e].image)) : t.push(_(n[e]));
            } else t = _(n);
          ...
          return (
            e > a && e > m
              ? e < 0.01
                ...
                : ((n = g / (i = Math.sqrt(e))), (r = v / i))
              : a > m
                ? a < 0.01
                  ? ((i = 0.707106781), (n = 0), (r = 0.707106781))
                  : ((i = g / (n = Math.sqrt(a))), (r = x / n))
                : m < 0.01
    ...
    class S {
      ...
      applyQuaternion(e) {
        let t = this.x,
          ...
          u = -r * t - a * i - s * n;
        return (
          (this.x = l * o + -(u * r) + -(h * s) - -(c * a)),
          (this.y = h * o + -(u * a) + -(c * r) - -(l * s)),
          (this.z = c * o + -(u * s) + -(l * a) - -(h * r)),
          this
        );
      }
      project(e) {
      ...
      angleTo(e) {
        ...
        return 0 === t ? Math.PI / 2 : Math.acos(d(this.dot(e) / t, -1, 1));
      }
      distanceTo(e) {
        return Math.sqrt(this.distanceToSquared(e));
      }
    ...
    class L {
      constructor(
        e = new S(Infinity, Infinity, Infinity),
        t = new S(-1 / 0, -1 / 0, -1 / 0),
      ) {
      ...
      setFromCenterAndSize(e, t) {
        let i = R.copy(t).multiplyScalar(0.5);
      ...
      intersectsSphere(e) {
        return (
          this.clampPoint(e.center, R),
          R.distanceToSquared(e.center) <= e.radius * e.radius
        );
      }
      intersectsPlane(e) {
        let t, i;
      ...
      intersectsTriangle(e) {
        ...
        return (
          !!G(t, P, D, I, H) &&
          !!G((t = [1, 0, 0, 0, 1, 0, 0, 0, 1]), P, D, I, H) &&
          (F.crossVectors(N, z), G((t = [F.x, F.y, F.z]), P, D, I, H))
        );
      }
      clampPoint(e, t) {
        return (
      ...
      distanceToPoint(e) {
        return R.copy(e).clamp(this.min, this.max).sub(e).length();
      }
      getBoundingSphere(e) {
        return (
          void 0 === e &&
          ...
          (e.radius = 0.5 * this.getSize(R).length()),
          e
        );
      }
      intersect(e) {
    ...
    function G(e, t, i, n, r) {
      for (let a = 0, s = e.length - 3; a <= s; a += 3) {
        U.fromArray(e, a);
        let s = r.x * Math.abs(U.x) + r.y * Math.abs(U.y) + r.z * Math.abs(U.z),
          o = t.dot(U),
          l = i.dot(U),
          h = n.dot(U);
    ...
    class q {
      ...
      setFromPoints(e, t) {
        let i = this.center;
        void 0 !== t ? i.copy(t) : V.setFromPoints(e).getCenter(i);
        let n = 0;
      ...
      expandByPoint(e) {
        j.subVectors(e, this.center);
        let t = j.lengthSq();
        if (t > this.radius * this.radius) {
          let e = Math.sqrt(t),
            i = (e - this.radius) * 0.5;
          (this.center.add(j.multiplyScalar(i / e)), (this.radius += i));
        }
        return this;
      }
      union(e) {
        return (
          W.subVectors(e.center, this.center)
            .normalize()
            .multiplyScalar(e.radius),
          this.expandByPoint(k.copy(e.center).add(W)),
          this.expandByPoint(k.copy(e.center).sub(W)),
          this
        );
      }
      equals(e) {
    ...
    class ee {
      ...
      distanceSqToPoint(e) {
        let t = X.subVectors(e, this.origin).dot(this.direction);
        return t < 0
      ...
      distanceSqToSegment(e, t, i, n) {
        let r, a, s, o;
        (Y.copy(e).add(t).multiplyScalar(0.5),
          Z.copy(t).sub(e).normalize(),
          J.copy(this.origin).sub(Y));
        let l = 0.5 * e.distanceTo(t),
          h = -this.direction.dot(Z),
          c = J.dot(this.direction),
          u = -J.dot(Z),
          d = J.lengthSq(),
          p = Math.abs(1 - h * h);
        if (p > 0)
        ...
        return (
          ...
          n && n.copy(Z).multiplyScalar(a).add(Y),
          s
        );
      }
      intersectSphere(e, t) {
        X.subVectors(e.center, this.origin);
        let i = X.dot(this.direction),
          n = X.dot(X) - i * i,
          r = e.radius * e.radius;
        if (n > r) return null;
        let a = Math.sqrt(r - n),
      ...
      intersectTriangle(e, t, i, n, r) {
        let a;
        (Q.subVectors(t, e), K.subVectors(i, e), $.crossVectors(Q, K));
        let s = this.direction.dot($);
        if (s > 0) {
          if (n) return null;
          a = 1;
        } else {
        ...
        J.subVectors(this.origin, e);
        let o = a * this.direction.dot(K.crossVectors(J, K));
        if (o < 0) return null;
        let l = a * this.direction.dot(Q.cross(J));
    ...
    class et {
      ...
      extractRotation(e) {
        let t = this.elements,
          i = e.elements,
          n = 1 / ei.setFromMatrixColumn(e, 0).length(),
      ...
      makeRotationFromQuaternion(e) {
        return this.compose(er, e, ea);
      }
      lookAt(e, t, i) {
        let n = this.elements;
        return (
          el.subVectors(e, t),
          0 === el.lengthSq() && (el.z = 1),
          el.normalize(),
          es.crossVectors(i, el),
          0 === es.lengthSq() &&
            (1 === Math.abs(i.z) ? (el.x += 1e-4) : (el.z += 1e-4),
            el.normalize(),
            es.crossVectors(i, el)),
          es.normalize(),
          eo.crossVectors(el, es),
          (n[0] = es.x),
          (n[4] = eo.x),
          (n[8] = el.x),
          (n[1] = es.y),
      ...
      multiplyMatrices(e, t) {
        ...
        return (
          ...
          (r[5] = h * w + c * T + u * C + d * N),
          (r[9] = h * M + c * L + u * P + d * z),
          (r[13] = h * S + c * A + u * D + d * O),
          (r[2] = p * b + f * E + m * R + g * I),
          (r[6] = p * w + f * T + m * C + g * N),
          (r[10] = p * M + f * L + m * P + g * z),
          (r[14] = p * S + f * A + m * D + g * O),
          (r[3] = v * b + x * E + y * R + _ * I),
          (r[7] = v * w + x * T + y * C + _ * N),
      ...
      decompose(e, t, i) {
        let n = this.elements,
          r = ei.set(n[0], n[1], n[2]).length(),
          a = ei.set(n[4], n[5], n[6]).length(),
          s = ei.set(n[8], n[9], n[10]).length();
    ...
    let ei = new S(),
      ...
      ec = new M();
    class eu {
      constructor(e = 0, t = 0, i = 0, n = eu.DefaultOrder) {
          ...
          case "ZXY":
            ((this._x = Math.asin(d(u, -1, 1))),
              0.9999999 > Math.abs(u)
                ? ((this._y = Math.atan2(-c, p)), (this._z = Math.atan2(-a, l)))
                : ((this._y = 0), (this._z = Math.atan2(o, r))));
            break;
          case "ZYX":
            ((this._y = Math.asin(-d(c, -1, 1))),
      ...
      setFromQuaternion(e, t, i) {
        return (
          eh.makeRotationFromQuaternion(e),
          this.setFromRotationMatrix(eh, t, i)
        );
      }
      setFromVector3(e, t) {
    ...
    ((eu.prototype.isEuler = !0),
      (eu.DefaultOrder = "XYZ"),
      (eu.RotationOrders = ["XYZ", "YZX", "ZXY", "XZY", "YXZ", "ZYX"]));
    class ed {
      constructor() {
        this.mask = 1;
      }
    ...
    class eT extends o {
      ...
      rotateOnAxis(e, t) {
        return (em.setFromAxisAngle(e, t), this.quaternion.multiply(em), this);
      }
      rotateOnWorldAxis(e, t) {
        return (
          em.setFromAxisAngle(e, t),
          this.quaternion.premultiply(em),
          this
        );
      }
      rotateX(e) {
      ...
      translateOnAxis(e, t) {
        return (
          ef.copy(e).applyQuaternion(this.quaternion),
          this.position.add(ef.multiplyScalar(t)),
          this
        );
      }
      translateX(e) {
      ...
      worldToLocal(e) {
        return e.applyMatrix4(eg.copy(this.matrixWorld).invert());
      }
      lookAt(e, t, i) {
        e.isVector3 ? ev.copy(e) : ev.set(e, t, i);
        let n = this.parent;
        (this.updateWorldMatrix(!0, !1),
          ex.setFromMatrixPosition(this.matrixWorld),
          this.isCamera || this.isLight
            ? eg.lookAt(ex, ev, this.up)
            : eg.lookAt(ev, ex, this.up),
          this.quaternion.setFromRotationMatrix(eg),
          n &&
            (eg.extractRotation(n.matrixWorld),
            em.setFromRotationMatrix(eg),
            this.quaternion.premultiply(em.invert())));
      }
      add(e) {
      ...
      clear() {
        for (let e = 0; e < this.children.length; e++) {
          ...
          ((t.parent = null), t.dispatchEvent(eE));
        }
      ...
      attach(e) {
        return (
          this.updateWorldMatrix(!0, !1),
          eg.copy(this.matrixWorld).invert(),
          null !== e.parent &&
            (e.parent.updateWorldMatrix(!0, !1),
            eg.multiply(e.parent.matrixWorld)),
          e.applyMatrix4(eg),
          this.add(e),
      ...
      getWorldQuaternion(e) {
        return (
          void 0 === e &&
            ...
            (e = new M())),
          this.updateWorldMatrix(!0, !1),
          this.matrixWorld.decompose(ex, e, ey),
          e
        );
      }
      getWorldScale(e) {
        return (
          void 0 === e &&
            ...
            (e = new S())),
          this.updateWorldMatrix(!0, !1),
          this.matrixWorld.decompose(ex, e_, e),
          e
        );
      }
      getWorldDirection(e) {
    ...
    ((eT.DefaultUp = new S(0, 1, 0)),
      (eT.DefaultMatrixAutoUpdate = !0),
      (eT.prototype.isObject3D = !0));
    let eL = new S(),
      eA = new S(),
      eR = new g();
    class eC {
      ...
      setFromCoplanarPoints(e, t, i) {
        let n = eL.subVectors(i, t).cross(eA.subVectors(e, t)).normalize();
      ...
      applyMatrix4(e, t) {
        let i = t || eR.getNormalMatrix(e),
          n = this.coplanarPoint(eL).applyMatrix4(e),
    ...
    class eG {
      ...
      static getBarycoord(e, t, i, n, r) {
        (eP.subVectors(n, t), eD.subVectors(i, t), eI.subVectors(e, t));
        let a = eP.dot(eP),
          s = eP.dot(eD),
          o = eP.dot(eI),
          l = eD.dot(eD),
      ...
      static getUV(e, t, i, n, r, a, s, o) {
        return (
          this.getBarycoord(e, t, i, n, eN),
          o.set(0, 0),
          o.addScaledVector(r, eN.x),
          o.addScaledVector(a, eN.y),
          o.addScaledVector(s, eN.z),
          o
        );
      }
      ...
      getArea() {
        return (
          eP.subVectors(this.c, this.b),
          eD.subVectors(this.a, this.b),
          0.5 * eP.cross(eD).length()
        );
      }
      getMidpoint(e) {
        return (
      ...
      getNormal(e) {
        return eG.getNormal(this.a, this.b, this.c, e);
      }
      getPlane(e) {
        return (
          void 0 === e &&
      ...
      getBarycoord(e, t) {
        return eG.getBarycoord(e, this.a, this.b, this.c, t);
      }
      getUV(e, t, i, n, r) {
        return eG.getUV(e, this.a, this.b, this.c, t, i, n, r);
      }
      containsPoint(e) {
        return eG.containsPoint(e, this.a, this.b, this.c);
      }
      isFrontFacing(e) {
        return eG.isFrontFacing(this.a, this.b, this.c, e);
      }
      intersectsBox(e) {
      ...
      closestPointToPoint(e, t) {
        ...
        let r = this.a,
          a = this.b,
          s = this.c;
        (ez.subVectors(a, r), eO.subVectors(s, r), eH.subVectors(e, r));
        let o = ez.dot(eH),
          l = eO.dot(eH);
        ...
        let u = o * c - h * l;
        if (u <= 0 && o >= 0 && h <= 0)
          return ((i = o / (o - h)), t.copy(r).addScaledVector(ez, i));
        eU.subVectors(e, s);
        let d = ez.dot(eU),
          p = eO.dot(eU);
        ...
        let f = d * l - o * p;
        if (f <= 0 && l >= 0 && p <= 0)
          return ((n = l / (l - p)), t.copy(r).addScaledVector(eO, n));
        let m = h * p - d * c;
        if (m <= 0 && c - h >= 0 && d - p >= 0)
          return (
            eB.subVectors(s, a),
            (n = (c - h) / (c - h + (d - p))),
            t.copy(a).addScaledVector(eB, n)
          );
        let g = 1 / (m + f + u);
        return (
          (i = f * g),
          (n = u * g),
          t.copy(r).addScaledVector(ez, i).addScaledVector(eO, n)
        );
      }
      equals(e) {
    ...
    ((ek.prototype = Object.assign(Object.create(o.prototype), {
      constructor: ek,
      isMaterial: !0,
      onBuild: function () {},
      ...
      Object.defineProperty(ek.prototype, "needsUpdate", {
        set: function (e) {
          !0 === e && this.version++;
        },
      }));
    ...
    class eJ {
      ...
      setHSL(e, t, i) {
        if (
          ((e = ((e % 1) + 1) % 1), (t = d(t, 0, 1)), (i = d(i, 0, 1)), 0 === t)
        )
      ...
      getHSL(e) {
        ...
        if (o === s) ((t = 0), (i = 0));
          ...
          let e = s - o;
          switch (((i = l <= 0.5 ? e / (s + o) : e / (2 - s - o)), s)) {
            case n:
              t = (r - a) / e + 6 * (r < a);
              break;
            case r:
      ...
      lerpHSL(e, t) {
        var i, n, r;
        (this.getHSL(ej), e.getHSL(eq));
        let a = ((i = ej.h), (1 - t) * i + t * eq.h),
          s = ((n = ej.s), (1 - t) * n + t * eq.s),
          o = ((r = ej.l), (1 - t) * r + t * eq.l);
    ...
    eQ.prototype.isMeshBasicMaterial = !0;
    let eK = new S(),
      e$ = new m();
    class e0 {
      constructor(e, t, i) {
        ...
        if (2 === this.itemSize)
          for (let t = 0, i = this.count; t < i; t++)
            (e$.fromBufferAttribute(this, t),
              e$.applyMatrix3(e),
              this.setXY(t, e$.x, e$.y));
        else if (3 === this.itemSize)
          for (let t = 0, i = this.count; t < i; t++)
            (eK.fromBufferAttribute(this, t),
              eK.applyMatrix3(e),
              this.setXYZ(t, eK.x, eK.y, eK.z));
        return this;
      }
      applyMatrix4(e) {
        for (let t = 0, i = this.count; t < i; t++)
    ...
    e0.prototype.isBufferAttribute = !0;
    class e1 extends e0 {
      constructor(e, t, i) {
    ...
    class ti extends o {
      constructor() {
        (super(),
          Object.defineProperty(this, "id", { value: e5++ }),
          (this.uuid = u()),
          (this.name = ""),
      ...
      setIndex(e) {
        return (
          Array.isArray(e)
            ? (this.index = new (e4(e) > 65535 ? e3 : e1)(e, 1))
            : (this.index = e),
          this
        );
      }
      ...
      rotateX(e) {
        return (e6.makeRotationX(e), this.applyMatrix4(e6), this);
      }
      rotateY(e) {
        return (e6.makeRotationY(e), this.applyMatrix4(e6), this);
      }
      rotateZ(e) {
        return (e6.makeRotationZ(e), this.applyMatrix4(e6), this);
      }
      translate(e, t, i) {
        return (e6.makeTranslation(e, t, i), this.applyMatrix4(e6), this);
      }
      scale(e, t, i) {
        return (e6.makeScale(e, t, i), this.applyMatrix4(e6), this);
      }
      lookAt(e) {
        return (
          e8.lookAt(e),
          e8.updateMatrix(),
          this.applyMatrix4(e8.matrix),
          this
        );
      }
      center() {
        return (
          ...
          this.boundingBox.getCenter(e7).negate(),
          this.translate(e7.x, e7.y, e7.z),
          this
        );
      }
      setFromPoints(e) {
        ...
        return (this.setAttribute("position", new e2(t, 3)), this);
      }
      computeBoundingBox() {
        null === this.boundingBox && (this.boundingBox = new L());
        ...
        if (e && e.isGLBufferAttribute) {
          (console.error(
            ...
            this.boundingBox.set(
              new S(-1 / 0, -1 / 0, -1 / 0),
              new S(Infinity, Infinity, Infinity),
            ));
          return;
        }
        if (void 0 !== e) {
          if ((this.boundingBox.setFromBufferAttribute(e), t))
            for (let e = 0, i = t.length; e < i; e++) {
              let i = t[e];
              (e9.setFromBufferAttribute(i),
                this.morphTargetsRelative
                  ? (tt.addVectors(this.boundingBox.min, e9.min),
                    this.boundingBox.expandByPoint(tt),
                    tt.addVectors(this.boundingBox.max, e9.max),
                    this.boundingBox.expandByPoint(tt))
                  : (this.boundingBox.expandByPoint(e9.min),
                    this.boundingBox.expandByPoint(e9.max)));
            }
      ...
      computeBoundingSphere() {
        ...
        if (e) {
          ...
          if ((e9.setFromBufferAttribute(e), t))
            for (let e = 0, i = t.length; e < i; e++) {
              let i = t[e];
              (te.setFromBufferAttribute(i),
                this.morphTargetsRelative
                  ? (tt.addVectors(e9.min, te.min),
                    e9.expandByPoint(tt),
                    tt.addVectors(e9.max, te.max),
                    e9.expandByPoint(tt))
                  : (e9.expandByPoint(te.min), e9.expandByPoint(te.max)));
            }
          e9.getCenter(i);
          let n = 0;
            ...
            for (let r = 0, a = t.length; r < a; r++) {
              ...
              for (let t = 0, r = a.count; t < r; t++)
                (tt.fromBufferAttribute(a, t),
                  s && (e7.fromBufferAttribute(e, t), tt.add(e7)),
                  (n = Math.max(n, i.distanceToSquared(tt))));
            }
      ...
      computeTangents() {
        ...
        let i = e.array,
          ...
          s = n.length / 3;
        void 0 === t.tangent &&
          this.setAttribute("tangent", new e0(new Float32Array(4 * s), 4));
        let o = t.tangent.array,
          l = [],
          h = [];
        for (let e = 0; e < s; e++) ((l[e] = new S()), (h[e] = new S()));
        let c = new S(),
          u = new S(),
          d = new S(),
          p = new m(),
      ...
      computeVertexNormals() {
        ...
        if (void 0 !== t) {
          ...
          if (void 0 === i)
            ((i = new e0(new Float32Array(3 * t.count), 3)),
      ...
      raycast(e, t) {
        ...
        if (void 0 !== r) {
          if (
            ...
            (tn.copy(a).invert(),
            tr.copy(e.ray).applyMatrix4(tn),
            null === n.boundingBox || !1 !== tr.intersectsBox(n.boundingBox))
          )
              ...
              if (null !== a)
                if (Array.isArray(r))
                  ...
                  let n = Math.max(0, d.start),
                    u = Math.min(a.count, d.start + d.count);
                  for (let d = n; d < u; d += 3)
                    (i = tb(
                      this,
                      r,
                      ...
                      a.getX(d + 1),
                      a.getX(d + 2),
                    )) && ((i.faceIndex = Math.floor(d / 3)), t.push(i));
                }
              else if (void 0 !== s)
                if (Array.isArray(r))
                  ...
                  for (let u = n; u < a; u += 3)
                    (i = tb(this, r, e, tr, s, o, l, h, c, u, u + 1, u + 2)) &&
    ...
    function tb(e, t, i, n, r, a, s, o, l, h, c, u) {
      (ts.fromBufferAttribute(r, h),
        to.fromBufferAttribute(r, c),
        tl.fromBufferAttribute(r, u));
      let d = e.morphTargetInfluences;
      if (t.morphTargets && a && d) {
        (td.set(0, 0, 0), tp.set(0, 0, 0), tf.set(0, 0, 0));
        for (let e = 0, t = a.length; e < t; e++) {
          let t = d[e],
            i = a[e];
          0 !== t &&
            (th.fromBufferAttribute(i, h),
            tc.fromBufferAttribute(i, c),
            tu.fromBufferAttribute(i, u),
            s
              ? (td.addScaledVector(th, t),
                tp.addScaledVector(tc, t),
                tf.addScaledVector(tu, t))
              : (td.addScaledVector(th.sub(ts), t),
                tp.addScaledVector(tc.sub(to), t),
                tf.addScaledVector(tu.sub(tl), t)));
        }
        (ts.add(td), to.add(tp), tl.add(tf));
      }
      e.isSkinnedMesh &&
        t.skinning &&
        (e.boneTransform(h, ts),
        e.boneTransform(c, to),
        e.boneTransform(u, tl));
      let p = (function (e, t, i, n, r, a, s, o) {
        if (
          null ===
          (1 === t.side
            ? n.intersectTriangle(s, a, r, !0, o)
            : n.intersectTriangle(r, a, s, 2 !== t.side, o))
        )
          return null;
        (ty.copy(o), ty.applyMatrix4(e.matrixWorld));
        let l = i.ray.origin.distanceTo(ty);
        return l < i.near || l > i.far
          ? null
          : { distance: l, point: ty.clone(), object: e };
      })(e, t, i, n, ts, to, tl, tx);
      if (p) {
        (o &&
          (tm.fromBufferAttribute(o, h),
          tg.fromBufferAttribute(o, c),
          tv.fromBufferAttribute(o, u),
          (p.uv = eG.getUV(tx, ts, to, tl, tm, tg, tv, new m()))),
          l &&
            (tm.fromBufferAttribute(l, h),
            tg.fromBufferAttribute(l, c),
            tv.fromBufferAttribute(l, u),
            (p.uv2 = eG.getUV(tx, ts, to, tl, tm, tg, tv, new m()))));
        let e = { a: h, b: c, c: u, normal: new S(), materialIndex: 0 };
        (eG.getNormal(ts, to, tl, e.normal), (p.face = e));
      }
      return p;
    }
    t_.prototype.isMesh = !0;
    class tw extends ti {
      constructor(e = 1, t = 1, i = 1, n = 1, r = 1, a = 1) {
        ...
        (p("z", "y", "x", -1, -1, i, t, e, (a = Math.floor(a)), r, 0),
          ...
          this.setIndex(o),
          this.setAttribute("position", new e2(l, 3)),
          this.setAttribute("normal", new e2(h, 3)),
          this.setAttribute("uv", new e2(c, 2)));
      }
    }
    function tM(e) {
      let t = {};
    ...
    tE.prototype.isShaderMaterial = !0;
    class tT extends eT {
      constructor() {
        (super(),
          (this.type = "Camera"),
    ...
    class tL extends tT {
      ...
      setFocalLength(e) {
        ...
        ((this.fov = 2 * c * Math.atan(t)), this.updateProjectionMatrix());
      }
      getFocalLength() {
        let e = Math.tan(0.5 * h * this.fov);
        return (0.5 * this.getFilmHeight()) / e;
      }
      getEffectiveFOV() {
        return 2 * c * Math.atan(Math.tan(0.5 * h * this.fov) / this.zoom);
      }
      getFilmWidth() {
      ...
      updateProjectionMatrix() {
        let e = this.near,
          t = (e * Math.tan(0.5 * h * this.fov)) / this.zoom,
          i = 2 * t,
          n = this.aspect * i,
          r = -0.5 * n,
          a = this.view;
    ...
    tL.prototype.isPerspectiveCamera = !0;
    class tA extends eT {
      constructor(e, t, i) {
        if (
          (super(),
        ...
        this.renderTarget = i;
        const n = new tL(90, 1, e, t);
        ((n.layers = this.layers),
          n.up.set(0, -1, 0),
          n.lookAt(new S(1, 0, 0)),
          this.add(n));
        const r = new tL(90, 1, e, t);
        ((r.layers = this.layers),
          r.up.set(0, -1, 0),
          r.lookAt(new S(-1, 0, 0)),
          this.add(r));
        const a = new tL(90, 1, e, t);
        ((a.layers = this.layers),
          a.up.set(0, 0, 1),
          a.lookAt(new S(0, 1, 0)),
          this.add(a));
        const s = new tL(90, 1, e, t);
        ((s.layers = this.layers),
          s.up.set(0, 0, -1),
          s.lookAt(new S(0, -1, 0)),
          this.add(s));
        const o = new tL(90, 1, e, t);
        ((o.layers = this.layers),
          o.up.set(0, -1, 0),
          o.lookAt(new S(0, 0, 1)),
          this.add(o));
        const l = new tL(90, 1, e, t);
    ...
    tC.prototype.isWebGLCubeRenderTarget = !0;
    class tP extends y {
    ...
    class tN {
      ...
      setFromProjectionMatrix(e) {
        let t = this.planes,
          ...
          x = i[15];
        return (
          t[0].setComponents(s - n, c - o, f - u, x - m).normalize(),
          t[1].setComponents(s + n, c + o, f + u, x + m).normalize(),
          t[2].setComponents(s + r, c + l, f + d, x + g).normalize(),
          t[3].setComponents(s - r, c - l, f - d, x - g).normalize(),
          t[4].setComponents(s - a, c - h, f - p, x - v).normalize(),
          t[5].setComponents(s + a, c + h, f + p, x + v).normalize(),
          this
        );
      }
      intersectsObject(e) {
      ...
      intersectsBox(e) {
        ...
        for (let i = 0; i < 6; i++) {
          let n = t[i];
          if (
            ((tI.x = n.normal.x > 0 ? e.max.x : e.min.x),
            (tI.y = n.normal.y > 0 ? e.max.y : e.min.y),
            (tI.z = n.normal.z > 0 ? e.max.z : e.min.z),
            0 > n.distanceToPoint(tI))
          )
            return !1;
        }
        return !0;
                      ...
                      : s instanceof Uint32Array
                        ...
                        : s instanceof Int32Array
                          ...
                          : s instanceof Int8Array
                            ? (h = 5120)
                            : s instanceof Uint8Array && (h = 5121),
              {
                buffer: l,
                type: h,
    ...
    class tB extends ti {
      constructor(e = 1, t = 1, i = 1, n = 1) {
        ...
        (this.setIndex(d),
          this.setAttribute("position", new e2(p, 3)),
          this.setAttribute("normal", new e2(f, 3)),
          this.setAttribute("uv", new e2(m, 2)));
      }
    }
    let tH = {
        alphamap_fragment:
      ...
      tF = {
        ...
        fog: {
          ...
          fogNear: { value: 1 },
          fogFar: { value: 2e3 },
          fogColor: { value: new eJ(0xffffff) },
        },
        lights: {
      ...
      tU = {
        ...
        depth: {
          uniforms: tS([tF.common, tF.displacementmap]),
        ...
        cube: {
          uniforms: tS([tF.envmap, { opacity: { value: 1 } }]),
        ...
        shadow: {
          uniforms: tS([
            tF.lights,
            tF.fog,
            { color: { value: new eJ(0) }, opacity: { value: 1 } },
          ]),
              ...
              ? (void 0 === s &&
                  ((s = new t_(
                    ...
                    new tE({
                      ...
                      uniforms: tM(tU.cube.uniforms),
                      vertexShader: tU.cube.vertexShader,
                      fragmentShader: tU.cube.fragmentShader,
                      side: 1,
                      depthTest: !1,
                      depthWrite: !1,
                      fog: !1,
                ...
                (h !== m || c !== m.version || u !== e.toneMapping) &&
                ...
                (void 0 === a &&
                  ((a = new t_(
                    ...
                    new tE({
                      ...
                      uniforms: tM(tU.background.uniforms),
          ...
          if (s) {
            ...
            let t,
              ...
              p =
                ...
                (w = u),
                (t = !0 === l.wireframe),
                void 0 === (i = o[b.id]) && ((i = {}), (o[b.id] = i)),
                void 0 === (r = i[w.id]) && ((r = {}), (i[w.id] = r)),
                void 0 === (s = r[t]) &&
                  ((s = d(
                    n.isWebGL2
                      ? e.createVertexArray()
            ...
            (h !== p && c((h = p).object),
              (_ = (function (e, t) {
                ...
                for (let e in n) {
                  let t = i[e],
                    a = n[e];
                  if (void 0 === t || t.attribute !== a || t.data !== a.data)
                    return !0;
                  r++;
                }
            ...
            let e = !0 === l.wireframe;
            (h.geometry !== x.id || h.program !== u.id || h.wireframe !== e) &&
              ((h.geometry = x.id),
              (h.program = u.id),
              (h.wireframe = e),
              (_ = !0));
                  ...
                  if (n >= 0) {
                    ...
                    if (void 0 !== a) {
                      ...
                      (m(n + 0, 1),
                        ...
                        e.vertexAttribPointer(n + 0, 4, s, !1, 64, 0),
                        e.vertexAttribPointer(n + 1, 4, s, !1, 64, 16),
                        e.vertexAttribPointer(n + 2, 4, s, !1, 64, 32),
                        e.vertexAttribPointer(n + 3, 4, s, !1, 64, 48));
                      ...
                      (m(n, 1),
                        e.bindBuffer(34962, a),
                        e.vertexAttribPointer(n, 3, s, !1, 12, 0));
                    } else if (void 0 !== c) {
                      let i = c[t];
                      if (void 0 !== i)
                        switch (i.length) {
    ...
    function tY(e, t, i, n) {
      ...
      function o(e) {
        ...
        let o = new (e4(i) > 65535 ? e3 : e1)(i, 1);
        o.version = s;
        let l = a.get(e);
          ...
          for (let e = 0; e < 8; e++) {
            ...
            r !== Number.MAX_SAFE_INTEGER && s
              ? (u &&
                ...
                d &&
                  a.getAttribute("morphNormal" + e) !== d[r] &&
                  a.setAttribute("morphNormal" + e, d[r]),
                (i[e] = s),
                (p += s))
              : (u &&
    ...
    t1.prototype.isDataTexture2DArray = !0;
    class t3 extends y {
      constructor(e = null, t = 1, i = 1, n = 1) {
        (super(null),
          (this.image = { data: e, width: t, height: i, depth: n }),
    ...
    t3.prototype.isDataTexture3D = !0;
    let t2 = new y(),
      t4 = new t1(),
      t5 = new t3(),
      t6 = new tR(),
    ...
    function ii(e, t, i) {
      ...
      let r = t * i,
        a = t8[r];
      if ((void 0 === a && ((a = new Float32Array(r)), (t8[r] = a)), 0 !== t)) {
        n.toArray(a, 0);
    ...
    function is(e, t) {
      let i = t7[t];
      void 0 === i && ((i = new Int32Array(t)), (t7[t] = i));
    ...
    function il(e, t) {
      ...
      if (void 0 !== t.x)
        ...
        if (ir(i, t)) return;
        (e.uniform2fv(this.addr, t), ia(i, t));
      }
    }
    function ih(e, t) {
      let i = this.cache;
      if (void 0 !== t.x)
        ...
        if (ir(i, t)) return;
        (e.uniform3fv(this.addr, t), ia(i, t));
      }
    }
    function ic(e, t) {
      let i = this.cache;
      if (void 0 !== t.x)
        ...
        if (ir(i, t)) return;
        (e.uniform4fv(this.addr, t), ia(i, t));
      }
    }
    function iu(e, t) {
      let i = this.cache,
      ...
      if (void 0 === n) {
        if (ir(i, t)) return;
        (e.uniformMatrix2fv(this.addr, !1, t), ia(i, t));
      } else {
        if (ir(i, n)) return;
        (it.set(n), e.uniformMatrix2fv(this.addr, !1, it), ia(i, n));
      }
    }
    function id(e, t) {
      let i = this.cache,
      ...
      if (void 0 === n) {
        if (ir(i, t)) return;
        (e.uniformMatrix3fv(this.addr, !1, t), ia(i, t));
      } else {
        if (ir(i, n)) return;
        (ie.set(n), e.uniformMatrix3fv(this.addr, !1, ie), ia(i, n));
      }
    }
    function ip(e, t) {
      let i = this.cache,
      ...
      if (void 0 === n) {
        if (ir(i, t)) return;
        (e.uniformMatrix4fv(this.addr, !1, t), ia(i, t));
      } else {
        if (ir(i, n)) return;
        (t9.set(n), e.uniformMatrix4fv(this.addr, !1, t9), ia(i, n));
      }
    }
    function im(e, t) {
      let i = this.cache;
    ...
    function ig(e, t) {
      let i = this.cache;
      ir(i, t) || (e.uniform2iv(this.addr, t), ia(i, t));
    }
    function iv(e, t) {
      let i = this.cache;
      ir(i, t) || (e.uniform3iv(this.addr, t), ia(i, t));
    }
    function ix(e, t) {
      let i = this.cache;
      ir(i, t) || (e.uniform4iv(this.addr, t), ia(i, t));
    }
    function iy(e, t) {
      let i = this.cache;
    ...
    function i_(e, t) {
      let i = this.cache;
      ir(i, t) || (e.uniform2uiv(this.addr, t), ia(i, t));
    }
    function ib(e, t) {
      let i = this.cache;
      ir(i, t) || (e.uniform3uiv(this.addr, t), ia(i, t));
    }
    function iw(e, t) {
      let i = this.cache;
      ir(i, t) || (e.uniform4uiv(this.addr, t), ia(i, t));
    }
    function iM(e, t, i) {
      let n = this.cache,
        r = i.allocateTextureUnit();
      (n[0] !== r && (e.uniform1i(this.addr, r), (n[0] = r)),
        i.safeSetTexture2D(t || t2, r));
    }
    function iS(e, t, i) {
      let n = this.cache,
        r = i.allocateTextureUnit();
      (n[0] !== r && (e.uniform1i(this.addr, r), (n[0] = r)),
        i.setTexture3D(t || t5, r));
    }
    function iE(e, t, i) {
      let n = this.cache,
        r = i.allocateTextureUnit();
      (n[0] !== r && (e.uniform1i(this.addr, r), (n[0] = r)),
        i.safeSetTextureCube(t || t6, r));
    }
    function iT(e, t, i) {
      let n = this.cache,
        r = i.allocateTextureUnit();
      (n[0] !== r && (e.uniform1i(this.addr, r), (n[0] = r)),
        i.setTexture2DArray(t || t4, r));
    }
    function iL(e, t) {
      e.uniform1fv(this.addr, t);
    }
    function iA(e, t) {
      let i = ii(t, this.size, 2);
      e.uniform2fv(this.addr, i);
    }
    function iR(e, t) {
      let i = ii(t, this.size, 3);
      e.uniform3fv(this.addr, i);
    }
    function iC(e, t) {
      let i = ii(t, this.size, 4);
    ...
    function iD(e, t) {
      let i = ii(t, this.size, 9);
      e.uniformMatrix3fv(this.addr, !1, i);
    }
    function iI(e, t) {
      let i = ii(t, this.size, 16);
    ...
    function iV(e, t, i) {
      ...
      for (let e = 0; e !== n; ++e) i.safeSetTexture2D(t[e] || t2, r[e]);
    }
    function ik(e, t, i) {
      let n = t.length,
        r = is(i, n);
      e.uniform1iv(this.addr, r);
      for (let e = 0; e !== n; ++e) i.safeSetTextureCube(t[e] || t6, r[e]);
    }
    function iW(e, t, i) {
      ((this.id = e),
        (this.addr = i),
    ...
    ((ij.prototype.updateCache = function (e) {
      let t = this.cache;
      ...
      (iq.prototype.setValue = function (e, t, i) {
        let n = this.seq;
        ...
        !(function (e, t, i) {
          ...
          for (iX.lastIndex = 0; ; ) {
            ...
            if ((l && (o |= 0), void 0 === h || ("[" === h && s + 2 === r))) {
              iY(i, void 0 === h ? new iW(o, e, t) : new ij(o, e, t));
              break;
            }
            {
              let e = i.map[o];
              (void 0 === e && iY(i, (e = new iq(o))), (i = e));
            }
          }
        })(i, r, this);
      }
    ...
    ((iZ.prototype.setValue = function (e, t, i, n) {
      let r = this.map[t];
      void 0 !== r && r.setValue(e, i, n);
    }),
      (iZ.prototype.setOptional = function (e, t, i) {
        let n = t[i];
        void 0 !== n && this.setValue(e, i, n);
      }),
      (iZ.upload = function (e, t, i, n) {
        for (let r = 0, a = t.length; r !== a; ++r) {
          let a = t[r],
            s = i[a.id];
    ...
    let i4 = /^[ \t]*#include +<([\w\d./]+)>/gm;
    function i5(e) {
      return e.replace(i4, i6);
    }
    function i6(e, t) {
      let i = tH[t];
    ...
    function i9(e) {
      return e.replace(i7, nt).replace(i8, ne);
    }
    function ne(e, t, i, n) {
      return (
        console.warn(
    ...
    function nn(e, t, i, n) {
        ...
        f =
          ...
          1 === i.shadowMapType
            ...
            : 2 === i.shadowMapType
              ...
              : 3 === i.shadowMapType && (h = "SHADOWMAP_TYPE_VSM"),
          h),
        m = (function (e) {
      ...
      if (i.isRawShaderMaterial)
        ...
        ((r = [
          ...
          (a = [
            ...
            0 !== i.toneMapping ? tH.tonemapping_pars_fragment : "",
            0 !== i.toneMapping
              ? (function (e, t) {
                  let i;
                  switch (t) {
            ...
            tH.encodings_pars_fragment,
            i.map ? i0("mapTexelToLinear", i.mapEncoding) : "",
            i.matcap ? i0("matcapTexelToLinear", i.matcapEncoding) : "",
            i.envMap ? i0("envMapTexelToLinear", i.envMapEncoding) : "",
            i.emissiveMap
              ? i0("emissiveMapTexelToLinear", i.emissiveMapEncoding)
              : "",
            i.lightMap ? i0("lightMapTexelToLinear", i.lightMapEncoding) : "",
            "vec4 linearToOutputTexel( vec4 value ) { return LinearTo" +
              (e = iK(i.outputEncoding))[0] +
              e[1] +
              "; }",
      ...
      ((d = i2((d = i3((d = i5(d)), i)), i)),
        (p = i2((p = i3((p = i5(p)), i)), i)),
        (d = i9(d)),
        (p = i9(p)),
        i.isWebGL2 &&
          ...
          (a =
            [
              "#define varying in",
              i.glslVersion === s ? "" : "out highp vec4 pc_fragColor;",
              i.glslVersion === s ? "" : "#define gl_FragColor pc_fragColor",
      ...
      if (
        ...
        void 0 !== i.index0AttributeName
          ? c.bindAttribLocation(b, 0, i.index0AttributeName)
          : !0 === i.morphTargets && c.bindAttribLocation(b, 0, "position"),
        c.linkProgram(b),
        e.debug.checkShaderErrors)
      ) {
        let e = c.getProgramInfoLog(b).trim(),
          t = c.getShaderInfoLog(E).trim(),
          i = c.getShaderInfoLog(T).trim(),
          n = !0,
          s = !0;
      ...
      return (
        ...
        (this.getUniforms = function () {
          return (void 0 === o && (o = new iZ(c, b)), o);
        }),
    ...
    function nr(e, t, i, n, r, a) {
      ...
      return {
        getParameters: function (r, s, f, g, v) {
          ...
          if (
            (null !== r.precision &&
              (d = n.getMaxPrecision(r.precision)) !== r.precision &&
              console.warn(
        ...
        getProgramCacheKey: function (t) {
          ...
          if (!1 === t.isRawShaderMaterial) {
            for (let e = 0; e < f.length; e++) i.push(t[f[e]]);
        ...
        getUniforms: function (e) {
          let t,
            i = p[e.type];
          return (t = i ? tM(tU[i].uniforms) : e.uniforms);
        },
        acquireProgram: function (t, i) {
          ...
          return (void 0 === n && ((n = new nn(e, i, t, r)), s.push(n)), n);
        },
    ...
    function nl(e) {
      ...
      return {
        ...
        sort: function (e, t) {
          (n.length > 1 && n.sort(e || ns), r.length > 1 && r.sort(t || no));
        },
      };
    }
    function nh(e) {
      ...
      return {
        get: function (i, n) {
          ...
          return (
            !1 === t.has(i)
              ? ((r = new nl(e)), t.set(i, [r]))
              : n >= t.get(i).length
                ? ((r = new nl(e)), t.get(i).push(r))
                : (r = t.get(i)[n]),
            r
          );
        },
        ...
        get: function (t) {
          ...
          switch (t.type) {
            case "DirectionalLight":
              i = { direction: new S(), color: new eJ() };
              break;
            case "SpotLight":
              i = {
                position: new S(),
              ...
              break;
            case "PointLight":
              i = { position: new S(), color: new eJ(), distance: 0, decay: 0 };
              break;
    ...
    function np(e, t) {
      ...
      for (let e = 0; e < 9; e++) a.probe.push(new S());
      let s = new S(),
        o = new et(),
        l = new et();
      return {
        setup: function (i) {
            ...
            if (t.isAmbientLight)
              ...
              if (
                ...
                ((i.shadowBias = e.bias),
                  ...
                  (a.pointShadow[c] = i),
                  (a.pointShadowMap[c] = _),
                  (a.pointShadowMatrix[c] = t.shadow.matrix),
                  m++);
              }
              ((a.point[c] = e), c++);
          ...
          (d > 0 &&
            (t.isWebGL2 || !0 === e.has("OES_texture_float_linear")
              ? ((a.rectAreaLTC1 = tF.LTC_FLOAT_1),
                (a.rectAreaLTC2 = tF.LTC_FLOAT_2))
              : !0 === e.has("OES_texture_half_float_linear")
                ? ((a.rectAreaLTC1 = tF.LTC_HALF_1),
                  (a.rectAreaLTC2 = tF.LTC_HALF_2))
                : console.error(
    ...
    function nm(e, t) {
      ...
      return {
        get: function (n, r = 0) {
          ...
          return (
            !1 === i.has(n)
              ? ((a = new nf(e, t)), i.set(n, [a]))
              : r >= i.get(n).length
                ? ((a = new nf(e, t)), i.get(n).push(a))
                : (a = i.get(n)[r]),
            a
          );
        },
    ...
    ng.prototype.isMeshDepthMaterial = !0;
    class nv extends ek {
      constructor(e) {
        (super(),
    ...
    function nx(e, t, i) {
      ...
      f.setAttribute(
        "position",
        new e0(new Float32Array([-1, -1, 0.5, 3, -1, 0.5, -1, 3, 0.5]), 3),
      );
      let g = new t_(f, d),
        v = this;
      function x(e, t, i) {
        ...
        return (
          void 0 === r &&
            ((r = new ng({ depthPacking: 3201, morphTargets: e, skinning: t })),
            (o[n] = r)),
          r
        );
      }
      function y(e, t, i) {
        ...
        return (
          void 0 === r &&
            ((r = new nv({ morphTargets: e, skinning: t })), (l[n] = r)),
          r
        );
      }
      function _(t, i, n, r, a, s, o) {
        let l = null,
          c = x,
          d = t.customDepthMaterial;
        if (
          (!0 === r.isPointLight && ((c = y), (d = t.customDistanceMaterial)),
          void 0 === d)
        ) {
          let e = !1;
          !0 === n.morphTargets &&
        ...
        return (
          ...
          3 === o
            ? (l.side = null !== n.shadowSide ? n.shadowSide : n.side)
            : (l.side = null !== n.shadowSide ? n.shadowSide : u[n.side]),
        ...
        (this.render = function (i, o, l) {
          ...
          for (let h = 0, u = i.length; h < u; h++) {
            ...
            if (
              ...
              let e = { minFilter: 1006, magFilter: 1006, format: 1023 };
              ((f.map = new w(r.x, r.y, e)),
                (f.map.texture.name = u.name + ".shadowMap"),
                (f.mapPass = new w(r.x, r.y, e)),
                f.camera.updateProjectionMatrix());
            }
            if (null === f.map) {
              let e = { minFilter: 1003, magFilter: 1003, format: 1023 };
              ((f.map = new w(r.x, r.y, e)),
                (f.map.texture.name = u.name + ".shadowMap"),
                f.camera.updateProjectionMatrix());
            }
                    ...
                    if (Array.isArray(n)) {
                      ...
                      for (let a = 0, h = t.length; a < h; a++) {
                        let h = t[a],
                          c = n[h.materialIndex];
                        if (c && c.visible) {
                          let t = _(r, i, c, o, s.near, s.far, l);
                          e.renderBufferDirect(s, null, i, t, r, h);
                        }
                      }
                    } else if (n.visible) {
                      let t = _(r, i, n, o, s.near, s.far, l);
          ...
          ((v.needsUpdate = !1), e.setRenderTarget(h, u, f));
        }));
    }
    function ny(e, t, i) {
      let n = i.isWebGL2,
      ...
      -1 !== A.indexOf("WebGL")
        ? (L = parseFloat(/^WebGL (\d)/.exec(A)[1]) >= 1)
        : -1 !== A.indexOf("OpenGL ES") &&
          (L = parseFloat(/^OpenGL ES (\d)/.exec(A)[1]) >= 2);
      let R = null,
        C = {},
        P = new b(0, 0, e.canvas.width, e.canvas.height),
        D = new b(0, 0, e.canvas.width, e.canvas.height);
      function I(t, i, n) {
      ...
      ((N[3553] = I(3553, 3553, 1)),
        (N[34067] = I(34067, 34069, 6)),
        r.setClear(0, 0, 0, 1),
        a.setClear(1),
        s.setClear(0),
        z(2929),
        ...
        z(2884),
        F(0));
      let B = { 100: 32774, 101: 32778, 102: 32779 };
      ...
      function F(t, i, n, r, a, s, o, l) {
        if (0 === t) {
          !0 === u && (O(3042), (u = !1));
          return;
        }
        if ((!1 === u && (z(3042), (u = !0)), 5 !== t)) {
          if (t !== d || l !== y) {
            if (
              ((100 !== p || 100 !== g) &&
            ...
            ((f = null), (m = null), (v = null), (x = null), (d = t), (y = l));
          }
          return;
        }
        ((a = a || i),
          ...
          (o = o || r),
          (i !== p || a !== g) &&
            (e.blendEquationSeparate(B[i], B[a]), (p = i), (g = a)),
          (n !== f || r !== m || s !== v || o !== x) &&
            (e.blendFuncSeparate(H[n], H[r], H[s], H[o]),
            (f = n),
            (m = r),
            (v = s),
            (x = o)),
      ...
      function V(t, i, n) {
        t
          ? (z(32823),
            (S !== i || E !== n) && (e.polygonOffset(i, n), (S = i), (E = n)))
          : O(32823);
      }
      function k(t) {
      ...
      return {
        ...
        bindTexture: function (t, i) {
          ...
          let n = C[R];
          (void 0 === n &&
            ((n = { type: void 0, texture: void 0 }), (C[R] = n)),
            (n.type !== t || n.texture !== i) &&
              (e.bindTexture(t, i || N[t]), (n.type = t), (n.texture = i)));
        },
        ...
        reset: function () {
          (e.disable(3042),
            ...
            e.stencilFunc(519, 0, 0xffffffff),
    ...
    function n_(e, t, i, n, r, a, s) {
      ...
      function S(t) {
        ...
        (a.removeEventListener("dispose", S),
          (i = a),
          void 0 !== (r = n.get(i)).__webglInit &&
            (e.deleteTexture(r.__webglTexture), n.remove(i)),
          a.isVideoTexture && m.delete(a),
          s.memory.textures--);
      }
      function E(t) {
        let i = t.target;
      ...
      function L(e, t) {
        ...
        if (
          ...
          if (void 0 === i)
            ...
            if (!1 !== i.complete) return void I(o, e, t);
            console.warn(
              "THREE.WebGLRenderer: Texture marked for update but image is incomplete",
            );
          }
        }
        (i.activeTexture(33984 + t), i.bindTexture(3553, o.__webglTexture));
      }
      function A(t, r) {
        let s = n.get(t);
        t.version > 0 && s.__version !== t.version
          ? (function (t, n, r) {
              ...
              for (let e = 0; e < 6; e++)
                o || h
                  ? (u[e] = h ? n.image[e].image : n.image[e])
                  : (u[e] = x(n.image[e], !1, !0, c));
              let d = u[0],
                p = y(d) || l,
                f = a.convert(n.format),
                m = a.convert(n.type),
                g = w(n.internalFormat, f, m);
              if ((P(34067, n, p), o)) {
                for (let e = 0; e < 6; e++) {
                  s = u[e].mipmaps;
              ...
              (_(n, p) && b(34067, n, d.width, d.height),
      ...
      let R = { 1e3: 10497, 1001: 33071, 1002: 33648 },
        C = {
          1003: 9728,
          1004: 9984,
          1005: 9986,
      ...
      function P(i, a, s) {
        if (
          (s
            ? (e.texParameteri(i, 10242, R[a.wrapS]),
              e.texParameteri(i, 10243, R[a.wrapT]),
              (32879 === i || 35866 === i) &&
                e.texParameteri(i, 32882, R[a.wrapR]),
        ...
        if (n.isDepthTexture)
          ...
          if (g.length > 0 && d) {
            for (let e = 0, t = g.length; e < t; e++)
              ((s = g[e]),
                i.texImage2D(3553, e, m, s.width, s.height, 0, p, f, s.data));
            ((n.generateMipmaps = !1), (t.__maxMipLevel = g.length - 1));
          } else
            (i.texImage2D(3553, 0, m, c.width, c.height, 0, p, f, c.data),
              (t.__maxMipLevel = 0));
          ...
          for (let e = 0, t = g.length; e < t; e++)
            ((s = g[e]), i.texImage2D(3553, e, m, p, f, s));
          ((n.generateMipmaps = !1), (t.__maxMipLevel = g.length - 1));
        } else (i.texImage2D(3553, 0, m, p, f, c), (t.__maxMipLevel = 0));
        (_(n, d) && b(o, n, c.width, c.height),
          (t.__version = n.version),
          n.onUpdate && n.onUpdate(n));
      }
      function N(t, r, s, o) {
        ...
        (32879 === o || 35866 === o
          ? i.texImage3D(o, 0, u, r.width, r.height, r.depth, 0, h, c, null)
          : i.texImage2D(o, 0, u, r.width, r.height, 0, h, c, null),
          i.bindFramebuffer(36160, t),
          e.framebufferTexture2D(36160, s, o, n.get(l).__webglTexture, 0),
      ...
      ((this.allocateTextureUnit = function () {
        ...
        (this.setupRenderTarget = function (t) {
          ...
          } else if (((o.__webglFramebuffer = e.createFramebuffer()), u))
            if (l) {
              ...
              let n = a.convert(r.format),
                s = a.convert(r.type),
                l = w(r.internalFormat, n, s),
                h = O(t);
              (e.renderbufferStorageMultisample(36161, h, l, t.width, t.height),
                i.bindFramebuffer(36160, o.__webglMultisampledFramebuffer),
          ...
          if (c) {
            (i.bindTexture(34067, h.__webglTexture), P(34067, r, p));
            for (let e = 0; e < 6; e++)
              N(o.__webglFramebuffer[e], t, 36064, 34069 + e);
            (_(r, p) && b(34067, r, t.width, t.height),
            ...
            (d &&
              ...
              P(e, r, p),
              N(o.__webglFramebuffer, t, 36064, e),
              _(r, p) && b(3553, r, t.width, t.height),
          ...
          t.depthBuffer &&
            (function (t) {
              ...
              if (t.depthTexture) {
                ...
                else if (1027 === t.depthTexture.format)
    ...
    function nb(e, t, i) {
      ...
      return {
        convert: function (e) {
          ...
          if (
            (37492 === e || 37496 === e) &&
            null !== (i = t.get("WEBGL_compressed_texture_etc"))
          ) {
          ...
          return 37808 === e ||
            ...
            ? null !== (i = t.get("WEBGL_compressed_texture_astc"))
              ...
              : null
            : 36492 === e
              ? null !== (i = t.get("EXT_texture_compression_bptc"))
                ? e
                : null
              : 1020 === e
                ? n
    ...
    nv.prototype.isMeshDistanceMaterial = !0;
    class nw extends tL {
      constructor(e = []) {
        (super(), (this.cameras = e));
      }
    }
    nw.prototype.isArrayCamera = !0;
    class nM extends eT {
      constructor() {
        (super(), (this.type = "Group"));
      }
    }
    nM.prototype.isGroup = !0;
    let nS = { type: "move" };
    class nE {
      constructor() {
    ...
    class nT extends o {
      constructor(e, t) {
        ...
        const h = [],
          c = new Map(),
          u = new tL();
        (u.layers.enable(1), (u.viewport = new b()));
        const d = new tL();
        (d.layers.enable(2), (d.viewport = new b()));
        const p = [u, d],
          f = new nw();
        ...
        function y(e) {
          ...
          for (let t = 0; t < e.removed.length; t++) {
            let i = e.removed[t],
              n = c.get(i);
            n &&
              (n.dispatchEvent({ type: "disconnected", data: i }), c.delete(i));
          }
        ...
        this.getCamera = function (e) {
          ((f.near = d.near = u.near = e.near),
            (f.far = d.far = u.far = e.far),
            (m !== f.near || g !== f.far) &&
          ...
          let t = e.parent,
            i = f.cameras;
          M(f, t);
          for (let e = 0; e < i.length; e++) M(i[e], t);
          ...
          if (2 === i.length) {
            let e, t, i, n, r, a, s, o, l, h, c, p, m;
            (_.setFromMatrixPosition(u.matrixWorld),
              w.setFromMatrixPosition(d.matrixWorld),
              (e = _.distanceTo(w)),
              (t = u.projectionMatrix.elements),
              (i = d.projectionMatrix.elements),
              (n = t[14] / (t[10] - 1)),
              (r = t[14] / (t[10] + 1)),
              (a = (t[9] + 1) / t[5]),
              (s = (t[9] - 1) / t[5]),
              (o = (t[8] - 1) / t[0]),
              (c = -((h = e / (-o + (l = (i[8] + 1) / i[0]))) * o)),
              u.matrixWorld.decompose(f.position, f.quaternion, f.scale),
              f.translateX(c),
              f.translateZ(h),
              ...
              (p = n + h),
              (m = r + h),
              f.projectionMatrix.makePerspective(
                n * o - c,
                n * l + (e - c),
                ((a * r) / m) * p,
                ((s * r) / m) * p,
          ...
          } else f.projectionMatrix.copy(u.projectionMatrix);
          return f;
        };
        let E = null;
        const T = new tz();
        (T.setAnimationLoop(function (e, t) {
          if (null !== (l = t.getViewerPose(s))) {
            ...
            let i = !1;
            e.length !== f.cameras.length && ((f.cameras.length = 0), (i = !0));
            for (let n = 0; n < e.length; n++) {
              ...
              (s.matrix.fromArray(r.transform.matrix),
                ...
                0 === n && f.matrix.copy(s.matrix),
                !0 === i && f.cameras.push(s));
            }
          }
                        ...
                        : i.alphaMap
                          ...
                          : i.emissiveMap
                            ...
                            : i.clearcoatMap
                              ? (n = i.clearcoatMap)
                              : i.clearcoatNormalMap
                                ? (n = i.clearcoatNormalMap)
                                : i.clearcoatRoughnessMap &&
                                  (n = i.clearcoatRoughnessMap),
          void 0 !== n &&
        ...
        refreshMaterialUniforms: function (e, n, r, a) {
          ...
          n.isMeshBasicMaterial
            ...
            : n.isMeshLambertMaterial
              ? (t(e, n),
                (s = e),
                (o = n).emissiveMap && (s.emissiveMap.value = o.emissiveMap))
              : n.isMeshToonMaterial
                ? (t(e, n),
                  (l = e),
                  (h = n).gradientMap && (l.gradientMap.value = h.gradientMap),
                  h.emissiveMap && (l.emissiveMap.value = h.emissiveMap),
                  h.bumpMap &&
                    ((l.bumpMap.value = h.bumpMap),
                    (l.bumpScale.value = h.bumpScale),
                    1 === h.side && (l.bumpScale.value *= -1)),
                  h.normalMap &&
                    ((l.normalMap.value = h.normalMap),
                    l.normalScale.value.copy(h.normalScale),
                    1 === h.side && l.normalScale.value.negate()),
                  h.displacementMap &&
                    ((l.displacementMap.value = h.displacementMap),
                    (l.displacementScale.value = h.displacementScale),
                    (l.displacementBias.value = h.displacementBias)))
                : n.isMeshPhongMaterial
                  ? (t(e, n),
                    ...
                    u.emissiveMap && (c.emissiveMap.value = u.emissiveMap),
                    u.bumpMap &&
                      ((c.bumpMap.value = u.bumpMap),
                      (c.bumpScale.value = u.bumpScale),
                      1 === u.side && (c.bumpScale.value *= -1)),
                    u.normalMap &&
                      ((c.normalMap.value = u.normalMap),
                      c.normalScale.value.copy(u.normalScale),
                      1 === u.side && c.normalScale.value.negate()),
                    u.displacementMap &&
                      ((c.displacementMap.value = u.displacementMap),
                      (c.displacementScale.value = u.displacementScale),
                      (c.displacementBias.value = u.displacementBias)))
                  : n.isMeshStandardMaterial
                    ...
                    : n.isMeshMatcapMaterial
                      ? (t(e, n),
                        (f = e),
                        (m = n).matcap && (f.matcap.value = m.matcap),
                        m.bumpMap &&
                          ((f.bumpMap.value = m.bumpMap),
                          (f.bumpScale.value = m.bumpScale),
                          1 === m.side && (f.bumpScale.value *= -1)),
                        m.normalMap &&
                          ((f.normalMap.value = m.normalMap),
                          f.normalScale.value.copy(m.normalScale),
                          1 === m.side && f.normalScale.value.negate()),
                        m.displacementMap &&
                          ((f.displacementMap.value = m.displacementMap),
                          (f.displacementScale.value = m.displacementScale),
                          (f.displacementBias.value = m.displacementBias)))
                        ...
                        : n.isMeshDistanceMaterial
                          ? (t(e, n),
                            ...
                            (y = n).displacementMap &&
                              ...
                              (x.displacementScale.value = y.displacementScale),
                              (x.displacementBias.value = y.displacementBias)),
                            x.referencePosition.value.copy(y.referencePosition),
                            (x.nearDistance.value = y.nearDistance),
                            (x.farDistance.value = y.farDistance))
                          : n.isMeshNormalMaterial
                            ? (t(e, n),
                              (_ = e),
                              (b = n).bumpMap &&
                                ((_.bumpMap.value = b.bumpMap),
                                (_.bumpScale.value = b.bumpScale),
                                1 === b.side && (_.bumpScale.value *= -1)),
                              b.normalMap &&
                                ((_.normalMap.value = b.normalMap),
                                _.normalScale.value.copy(b.normalScale),
                                1 === b.side && _.normalScale.value.negate()),
                              b.displacementMap &&
                                ((_.displacementMap.value = b.displacementMap),
                                (_.displacementScale.value =
                                  b.displacementScale),
                                (_.displacementBias.value =
                                  b.displacementBias)))
                            : n.isLineBasicMaterial
                              ? ((w = e),
                                (M = n),
                                w.diffuse.value.copy(M.color),
                                (w.opacity.value = M.opacity),
                                n.isLineDashedMaterial &&
                                  ((S = e),
                                  (E = n),
                                  (S.dashSize.value = E.dashSize),
                                  (S.totalSize.value = E.dashSize + E.gapSize),
                                  (S.scale.value = E.scale)))
                              : n.isPointsMaterial
                                ? ((T = e),
                                  (L = n),
                                  (A = r),
                                  (R = a),
                                  T.diffuse.value.copy(L.color),
                                  (T.opacity.value = L.opacity),
                                  (T.size.value = L.size * A),
                                  (T.scale.value = 0.5 * R),
                                  L.map && (T.map.value = L.map),
                                  L.alphaMap && (T.alphaMap.value = L.alphaMap),
                                  L.map
                                    ? (D = L.map)
                                    : L.alphaMap && (D = L.alphaMap),
                                  void 0 !== D &&
                                    (!0 === D.matrixAutoUpdate &&
                                      D.updateMatrix(),
                                    T.uvTransform.value.copy(D.matrix)))
                                : n.isSpriteMaterial
                                  ? ((C = e),
                                    (P = n),
                                    ...
                                    P.map
                                      ? (I = P.map)
                                      : P.alphaMap && (I = P.alphaMap),
                                    void 0 !== I &&
                                      (!0 === I.matrixAutoUpdate &&
                                        I.updateMatrix(),
                                      C.uvTransform.value.copy(I.matrix)))
                                  : n.isShadowMaterial
    ...
    function nA(e) {
      let t,
        ...
        C = void 0 === e.depth || e.depth,
        P = void 0 === e.stencil || e.stencil,
      ...
      try {
        if (
          (L.addEventListener("webglcontextlost", ev, !1),
          L.addEventListener("webglcontextrestored", ex, !1),
          null === ep)
        ) {
        ...
        void 0 === ep.getShaderPrecisionFormat &&
          (ep.getShaderPrecisionFormat = function () {
      ...
      function ey(e) {
        ...
        let n,
          r = e.target;
        (r.removeEventListener("dispose", ey),
          (i = t = r),
          void 0 !== (n = a.get(i).programs) &&
      ...
      ((this.xr = eg),
        ...
        (this.getContextAttributes = function () {
          return ep.getContextAttributes();
        }),
        ...
        (this.setSize = function (e, t, i) {
          eg.isPresenting
            ...
            : ((Q = e),
              (K = t),
              (L.width = Math.floor(e * $)),
              (L.height = Math.floor(t * $)),
              !1 !== i &&
        ...
        (this.setViewport = function (e, t, i, r) {
          (e.isVector4 ? en.set(e.x, e.y, e.z, e.w) : en.set(e, t, i, r),
            n.viewport(Y.copy(en).multiplyScalar($).floor()));
        }),
        (this.getScissor = function (e) {
          return e.copy(er);
        }),
        (this.setScissor = function (e, t, i, r) {
          (e.isVector4 ? er.set(e.x, e.y, e.z, e.w) : er.set(e, t, i, r),
            n.scissor(Z.copy(er).multiplyScalar($).floor()));
        }),
        (this.getScissorTest = function () {
          return ea;
        }),
        (this.setScissorTest = function (e) {
          n.setScissorTest((ea = e));
        }),
        ...
        (this.dispose = function () {
          (L.removeEventListener("webglcontextlost", ev, !1),
            L.removeEventListener("webglcontextrestored", ex, !1),
            p.dispose(),
            f.dispose(),
            a.dispose(),
            o.dispose(),
            ...
            E.dispose(),
            eg.dispose(),
            eg.removeEventListener("sessionstart", eb),
            eg.removeEventListener("sessionend", ew),
            eM.stop());
        }),
        (this.renderBufferImmediate = function (e, t) {
          E.initAttributes();
          let i = a.get(e);
          (e.hasPositions && !i.position && (i.position = ep.createBuffer()),
            e.hasNormals && !i.normal && (i.normal = ep.createBuffer()),
            e.hasUvs && !i.uv && (i.uv = ep.createBuffer()),
            e.hasColors && !i.color && (i.color = ep.createBuffer()));
          let n = t.getAttributes();
          (e.hasPositions &&
            (ep.bindBuffer(34962, i.position),
            ep.bufferData(34962, e.positionArray, 35048),
            E.enableAttribute(n.position),
            ep.vertexAttribPointer(n.position, 3, 5126, !1, 0, 0)),
            e.hasNormals &&
              (ep.bindBuffer(34962, i.normal),
              ep.bufferData(34962, e.normalArray, 35048),
              E.enableAttribute(n.normal),
              ep.vertexAttribPointer(n.normal, 3, 5126, !1, 0, 0)),
            e.hasUvs &&
              (ep.bindBuffer(34962, i.uv),
              ep.bufferData(34962, e.uvArray, 35048),
              E.enableAttribute(n.uv),
              ep.vertexAttribPointer(n.uv, 2, 5126, !1, 0, 0)),
            e.hasColors &&
              (ep.bindBuffer(34962, i.color),
              ep.bufferData(34962, e.colorArray, 35048),
              E.enableAttribute(n.color),
              ep.vertexAttribPointer(n.color, 3, 5126, !1, 0, 0)),
            E.disableUnusedAttributes(),
            ep.drawArrays(4, 0, e.count),
            (e.count = 0));
        }),
        (this.renderBufferDirect = function (e, t, i, r, a, s) {
          let o;
          null === t && (t = eu);
          let c = a.isMesh && 0 > a.matrixWorld.determinant(),
            u = eA(e, t, r, a);
          n.setMaterial(r, c);
          let d = i.index,
          ...
          } else if (0 === d.count) return;
          let f = 1;
          (!0 === r.wireframe && ((d = h.getWireframeAttribute(i)), (f = 2)),
            (r.morphTargets || r.morphNormals) && y.update(a, i, r, u),
            E.setup(a, r, u, i, d));
          let m = _;
          null !== d && ((o = l.get(d)), (m = w).setIndex(o));
          let g = null !== d ? d.count : p.count,
            v = i.drawRange.start * f,
            x = i.drawRange.count * f,
            b = null !== s ? s.start * f : 0,
            M = null !== s ? s.count * f : 1 / 0,
            S = Math.max(v, b),
            T = Math.max(0, Math.min(g, v + x, b + M) - 1 - S + 1);
          if (0 !== T) {
            if (a.isMesh)
              !0 === r.wireframe
                ? (n.setLineWidth(r.wireframeLinewidth * ed()), m.setMode(1))
                : m.setMode(4);
            else if (a.isLine) {
              let e = r.linewidth;
              (void 0 === e && (e = 1),
            ...
            if (a.isInstancedMesh) m.renderInstances(S, T, a.count);
            else if (i.isInstancedBufferGeometry) {
              let e = Math.min(i.instanceCount, i._maxInstanceCount);
              m.renderInstances(S, T, e);
            } else m.render(S, T);
          }
        }),
        (this.compile = function (e, t) {
          ((H = f.get(e)).init(),
            ...
            e.traverse(function (t) {
              ...
              if (i)
                if (Array.isArray(i))
                  for (let n = 0; n < i.length; n++) eT(i[n], e, t);
                else eT(i, e, t);
            }));
        }));
      let e_ = null;
      ...
      function eE(e, t, i, r, a, s) {
        if (
          ...
          (n.setMaterial(a),
            E.reset(),
            e.render(function (e) {
              G.renderBufferImmediate(e, r);
            }));
        } else G.renderBufferDirect(i, t, r, a, e, s);
        e.onAfterRender(G, t, i, r, a, s);
      }
      function eT(e, t, i) {
        var n;
        !0 !== t.isScene && (t = eu);
        let r = a.get(e),
          s = H.state.lights,
          l = H.state.shadowsArray,
          h = s.state.version,
          c = u.getParameters(e, s.state, l, t, i),
          d = u.getProgramCacheKey(c),
          p = r.programs;
        ((r.environment = e.isMeshStandardMaterial ? t.environment : null),
          (r.fog = t.fog),
          (r.envMap = o.get(e.envMap || r.environment)),
          void 0 === p &&
            (e.addEventListener("dispose", ey), (r.programs = p = new Map())));
        let f = p.get(d);
        if (void 0 !== f) {
          if (r.currentProgram === f && r.lightsStateVersion === h)
            return (eL(e, c), f);
        } else
          ((c.uniforms = u.getUniforms(e)),
            e.onBuild(c, G),
            e.onBeforeCompile(c, G),
            (f = u.acquireProgram(c, d)),
            p.set(d, f),
            (r.uniforms = c.uniforms));
        let m = r.uniforms;
        (((e.isShaderMaterial || e.isRawShaderMaterial) && !0 !== e.clipping) ||
          (m.clippingPlanes = g.uniform),
          eL(e, c),
          (r.needsLights =
        ...
        let v = f.getUniforms(),
          x = iZ.seqWithValue(v.seq, m);
        return ((r.currentProgram = f), (r.uniformsList = x), f);
      }
      function eL(e, t) {
        let i = a.get(e);
      ...
      function eA(e, t, r, l) {
        var h, c;
        (!0 !== t.isScene && (t = eu), s.resetTextureUnits());
        let u = t.fog,
          p = r.isMeshStandardMaterial ? t.environment : null,
          f = null === j ? G.outputEncoding : j.texture.encoding,
          m = o.get(r.envMap || p),
          v =
            !0 === r.vertexColors &&
            l.geometry &&
            l.geometry.attributes.color &&
            4 === l.geometry.attributes.color.itemSize,
          x = a.get(r),
          y = H.state.lights;
        if (!0 === eo && (!0 === el || e !== X)) {
          let t = e === X && r.id === q;
        ...
        r.version === x.__version
          ? (x.needsLights && x.lightsStateVersion !== y.state.version) ||
            x.outputEncoding !== f ||
            (l.isInstancedMesh && !1 === x.instancing)
            ? (_ = !0)
            : l.isInstancedMesh || !0 !== x.instancing
              ? x.envMap !== m ||
                (r.fog && x.fog !== u) ||
                (void 0 !== x.numClippingPlanes &&
                  (x.numClippingPlanes !== g.numPlanes ||
                    x.numIntersection !== g.numIntersection))
                ? (_ = !0)
                : x.vertexAlphas !== v && (_ = !0)
              : (_ = !0)
          : ((_ = !0), (x.__version = r.version));
        ...
        let w = !1,
          ...
          T = x.uniforms;
        if (
          (n.useProgram(b.program) && ((w = !0), (M = !0), (S = !0)),
          r.id !== q && ((q = r.id), (M = !0)),
          w || X !== e)
        ) {
          if (
            (E.setValue(ep, "projectionMatrix", e.projectionMatrix),
            ...
            void 0 !== t &&
              t.setValue(ep, ec.setFromMatrixPosition(e.matrixWorld));
          }
          ((r.isMeshPhongMaterial ||
            r.isMeshToonMaterial ||
            ...
            r.isMeshStandardMaterial ||
            r.isShaderMaterial) &&
            E.setValue(ep, "isOrthographic", !0 === e.isOrthographicCamera),
            (r.isMeshPhongMaterial ||
              r.isMeshToonMaterial ||
              r.isMeshLambertMaterial ||
              r.isMeshBasicMaterial ||
              ...
              r.isShadowMaterial ||
              r.skinning) &&
              E.setValue(ep, "viewMatrix", e.matrixWorldInverse));
        }
        if (r.skinning) {
          (E.setOptional(ep, l, "bindMatrix"),
            E.setOptional(ep, l, "bindMatrixInverse"));
          let e = l.skeleton;
          if (e) {
            let t = e.bones;
            if (i.floatVertexTextures) {
              if (null === e.boneTexture) {
                let i = Math.sqrt(4 * t.length),
                  n = new Float32Array(
                    (i = Math.max(
                      (i = Math.pow(2, Math.ceil(Math.log(i) / Math.LN2))),
                      4,
                    )) *
                      i *
                      4,
                ...
                let r = new tP(n, i, i, 1023, 1015);
                ((e.boneMatrices = n),
                  (e.boneTexture = r),
                  (e.boneTextureSize = i));
              }
              (E.setValue(ep, "boneTexture", e.boneTexture, s),
                E.setValue(ep, "boneTextureSize", e.boneTextureSize));
            } else E.setOptional(ep, e, "boneMatrices");
          }
        }
        return (
          (M || x.receiveShadow !== l.receiveShadow) &&
            ((x.receiveShadow = l.receiveShadow),
            E.setValue(ep, "receiveShadow", l.receiveShadow)),
          M &&
            (E.setValue(ep, "toneMappingExposure", G.toneMappingExposure),
            x.needsLights &&
              ((h = T),
              (c = S),
              (h.ambientLightColor.needsUpdate = c),
              (h.lightProbe.needsUpdate = c),
              (h.directionalLights.needsUpdate = c),
              (h.directionalLightShadows.needsUpdate = c),
              (h.pointLights.needsUpdate = c),
              (h.pointLightShadows.needsUpdate = c),
              (h.spotLights.needsUpdate = c),
              (h.spotLightShadows.needsUpdate = c),
              (h.rectAreaLights.needsUpdate = c),
              (h.hemisphereLights.needsUpdate = c)),
            u && r.fog && d.refreshFogUniforms(T, u),
            d.refreshMaterialUniforms(T, r, $, K),
            iZ.upload(ep, x.uniformsList, T, s)),
          r.isShaderMaterial &&
            !0 === r.uniformsNeedUpdate &&
            (iZ.upload(ep, x.uniformsList, T, s), (r.uniformsNeedUpdate = !1)),
          r.isSpriteMaterial && E.setValue(ep, "center", l.center),
          E.setValue(ep, "modelViewMatrix", l.modelViewMatrix),
          E.setValue(ep, "normalMatrix", l.normalMatrix),
          E.setValue(ep, "modelMatrix", l.matrixWorld),
          b
        );
      }
      (eM.setAnimationLoop(function (e) {
        ...
        "undefined" != typeof window && eM.setContext(window),
        (this.setAnimationLoop = function (e) {
          ((e_ = e),
            eg.setAnimationLoop(e),
            null === e ? eM.stop() : eM.start());
        }),
        eg.addEventListener("sessionstart", eb),
        eg.addEventListener("sessionend", ew),
        (this.render = function (e, t) {
          ...
          (!0 === e.autoUpdate && e.updateMatrixWorld(),
            ...
            !0 === eg.enabled &&
              !0 === eg.isPresenting &&
              (t = eg.getCamera(t)),
            !0 === e.isScene && e.onBeforeRender(G, e, t, i || j),
            (H = f.get(e, U.length)).init(),
            U.push(H),
            eh.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse),
            es.setFromProjectionMatrix(eh),
            (el = this.localClippingEnabled),
            (eo = g.init(this.clippingPlanes, el, t)),
            (B = p.get(e, F.length)).init(),
            F.push(B),
            (function e(t, i, n, a) {
              ...
              if (t.layers.test(i.layers)) {
                if (t.isGroup) n = t.renderOrder;
                  ...
                  (H.pushLight(t), t.castShadow && H.pushShadow(t));
                else if (t.isSprite) {
                  if (!t.frustumCulled || es.intersectsSprite(t)) {
                    a &&
                      ec.setFromMatrixPosition(t.matrixWorld).applyMatrix4(eh);
                    let e = c.update(t),
                      i = t.material;
                    i.visible && B.push(t, e, i, n, ec.z, null);
                  }
                } else if (t.isImmediateRenderObject)
                  (a &&
                    ec.setFromMatrixPosition(t.matrixWorld).applyMatrix4(eh),
                    B.push(t, null, t.material, n, ec.z, null));
                else if (
                  (t.isMesh || t.isLine || t.isPoints) &&
                  (t.isSkinnedMesh &&
                    t.skeleton.frame !== r.render.frame &&
                    (t.skeleton.update(), (t.skeleton.frame = r.render.frame)),
                  !t.frustumCulled || es.intersectsObject(t))
                ) {
                  a && ec.setFromMatrixPosition(t.matrixWorld).applyMatrix4(eh);
                  let e = c.update(t),
                    i = t.material;
                  if (Array.isArray(i)) {
                    let r = e.groups;
                    for (let a = 0, s = r.length; a < s; a++) {
                      let s = r[a],
                        o = i[s.materialIndex];
                      o && o.visible && B.push(t, e, o, n, ec.z, s);
                    }
                  } else i.visible && B.push(t, e, i, n, ec.z, null);
                }
              }
              let s = t.children;
              for (let t = 0, r = s.length; t < r; t++) e(s[t], i, n, a);
            })(e, t, 0, G.sortObjects),
            B.finish(),
            !0 === G.sortObjects && B.sort(ee, ei),
            !0 === eo && g.beginShadows());
          let o = H.state.shadowsArray;
          (v.render(o, e, t),
            H.setupLights(),
            H.setupLightsView(t),
            !0 === eo && g.endShadows(),
          ...
          (l.length > 0 && eS(l, e, t),
            ...
            (X = null),
            U.pop(),
            (H = U.length > 0 ? U[U.length - 1] : null),
            F.pop(),
            (B = F.length > 0 ? F[F.length - 1] : null));
        }),
        ...
        (this.setRenderTarget = function (e, t = 0, i = 0) {
          ((j = e),
            ...
            e &&
              ...
              s.setupRenderTarget(e));
          let r = null,
            o = !1,
            l = !1;
          if (e) {
            let i = e.texture;
            (i.isDataTexture3D || i.isDataTexture2DArray) && (l = !0);
            let n = a.get(e).__webglFramebuffer;
            (e.isWebGLCubeRenderTarget
              ? ((r = n[t]), (o = !0))
            ...
            (Y.copy(en).multiplyScalar($).floor(),
              Z.copy(er).multiplyScalar($).floor(),
              (J = ea));
          if (
            (n.bindFramebuffer(36160, r),
            n.viewport(Y),
            n.scissor(Z),
            n.setScissorTest(J),
            o)
        ...
        (this.readRenderTargetPixels = function (e, r, s, o, l, h, c) {
          if (!(e && e.isWebGLRenderTarget))
            return void console.error(
              "THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.",
            );
          let u = a.get(e).__webglFramebuffer;
          if ((e.isWebGLCubeRenderTarget && void 0 !== c && (u = u[c]), u)) {
            n.bindFramebuffer(36160, u);
            try {
              let n = e.texture,
                a = n.format,
                c = n.type;
              if (1023 !== a && M.convert(a) !== ep.getParameter(35739))
                return void console.error(
              ...
              let u =
                ...
                (t.has("EXT_color_buffer_half_float") ||
                  (i.isWebGL2 && t.has("EXT_color_buffer_float")));
              if (
                1009 !== c &&
                M.convert(c) !== ep.getParameter(35738) &&
                !(
                  1015 === c &&
                  (i.isWebGL2 ||
                    t.has("OES_texture_float") ||
                    t.has("WEBGL_color_buffer_float"))
                ) &&
                !u
              )
                return void console.error(
              ...
              36053 === ep.checkFramebufferStatus(36160)
                ? r >= 0 &&
                  r <= e.width - o &&
                  s >= 0 &&
                  s <= e.height - l &&
                  ep.readPixels(r, s, o, l, M.convert(a), M.convert(c), h)
                : console.error(
                    "THREE.WebGLRenderer.readRenderTargetPixels: readPixels from renderTarget failed. Framebuffer not complete.",
                  );
            } finally {
              let e = null !== j ? a.get(j).__webglFramebuffer : null;
        ...
        (this.copyFramebufferToTexture = function (e, t, i = 0) {
          ...
          (s.setTexture2D(t, 0),
            ep.copyTexImage2D(3553, i, l, e.x, e.y, a, o, 0),
            n.unbindTexture());
        }),
        (this.copyTextureToTexture = function (e, t, i, r = 0) {
          let a = t.image.width,
            o = t.image.height,
            l = M.convert(i.format),
            h = M.convert(i.type);
          (s.setTexture2D(i, 0),
            ep.pixelStorei(37440, i.flipY),
            ep.pixelStorei(37441, i.premultiplyAlpha),
            ep.pixelStorei(3317, i.unpackAlignment),
            t.isDataTexture
              ? ep.texSubImage2D(3553, r, e.x, e.y, a, o, l, h, t.image.data)
              : t.isCompressedTexture
                ? ep.compressedTexSubImage2D(
                    3553,
                    r,
                    e.x,
                    e.y,
                ...
                : ep.texSubImage2D(3553, r, e.x, e.y, l, h, t.image),
            0 === r && i.generateMipmaps && ep.generateMipmap(3553),
            n.unbindTexture());
        }),
        (this.copyTextureToTexture3D = function (e, t, i, r, a = 0) {
          ...
          let { width: l, height: h, data: c } = i.image,
            u = M.convert(r.format),
            d = M.convert(r.type);
          if (r.isDataTexture3D) (s.setTexture3D(r, 0), (o = 32879));
          else {
            if (!r.isDataTexture2DArray)
              return void console.warn(
                "THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.",
              );
            (s.setTexture2DArray(r, 0), (o = 35866));
          }
          (ep.pixelStorei(37440, r.flipY),
            ep.pixelStorei(37441, r.premultiplyAlpha),
            ep.pixelStorei(3317, r.unpackAlignment));
          let p = ep.getParameter(3314),
            f = ep.getParameter(32878),
            m = ep.getParameter(3316),
            g = ep.getParameter(3315),
            v = ep.getParameter(32877);
          (ep.pixelStorei(3314, l),
            ep.pixelStorei(32878, h),
            ep.pixelStorei(3316, e.min.x),
            ep.pixelStorei(3315, e.min.y),
            ep.pixelStorei(32877, e.min.z),
            ep.texSubImage3D(
              o,
              a,
              t.x,
            ...
            ep.pixelStorei(3314, p),
            ep.pixelStorei(32878, f),
            ep.pixelStorei(3316, m),
            ep.pixelStorei(3315, g),
            ep.pixelStorei(32877, v),
            0 === a && r.generateMipmaps && ep.generateMipmap(o),
            n.unbindTexture());
        }),
        (this.initTexture = function (e) {
          (s.setTexture2D(e, 0), n.unbindTexture());
        }),
        (this.resetState = function () {
          ((k = 0), (W = 0), (j = null), n.reset(), E.reset());
        }),
    ...
    class nR {
      constructor(e, t = 25e-5) {
        ((this.name = ""), (this.color = new eJ(e)), (this.density = t));
      }
      clone() {
    ...
    nD.prototype.isInterleavedBuffer = !0;
    let nI = new S();
    class nN {
      constructor(e, t, i, n) {
        ((this.name = ""),
    ...
    nN.prototype.isInterleavedBufferAttribute = !0;
    class nz extends ek {
      constructor(e) {
        (super(),
    ...
    nz.prototype.isSpriteMaterial = !0;
    let nO = new S(),
      nB = new S(),
      nH = new S(),
      nF = new m(),
      ...
      nq = new m(),
      nX = new m();
    function nY(e, t, i, n, r, a) {
      (nF.subVectors(e, i).addScalar(0.5).multiply(n),
        void 0 !== r
          ? ((nU.x = a * nF.x - r * nF.y), (nU.y = r * nF.x + a * nF.y))
          : nU.copy(nF),
        e.copy(t),
        (e.x += nU.x),
        (e.y += nU.y),
    ...
    (class extends eT {
      constructor(e) {
        if ((super(), (this.type = "Sprite"), void 0 === i)) {
          i = new ti();
          const e = new nD(
            new Float32Array([
          ...
          (i.setIndex([0, 1, 2, 0, 2, 3]),
            i.setAttribute("position", new nN(e, 3, 0, !1)),
            i.setAttribute("uv", new nN(e, 2, 3, !1)));
        }
        ((this.geometry = i),
          (this.material = void 0 !== e ? e : new nz()),
      ...
      raycast(e, t) {
        ...
        (null === e.camera &&
          ...
          e.camera.isPerspectiveCamera &&
            ...
            nB.multiplyScalar(-nH.z));
        let r = this.material.rotation;
        0 !== r && ((n = Math.cos(r)), (i = Math.sin(r)));
        let a = this.center;
        (nY(nV.set(-0.5, -0.5, 0), nH, a, nB, i, n),
          nY(nk.set(0.5, -0.5, 0), nH, a, nB, i, n),
          nY(nW.set(0.5, 0.5, 0), nH, a, nB, i, n),
          nj.set(0, 0),
          nq.set(1, 0),
          nX.set(1, 1));
        let s = e.ray.intersectTriangle(nV, nk, nW, !1, nO);
        if (
          null === s &&
          (nY(nk.set(-0.5, 0.5, 0), nH, a, nB, i, n),
          nq.set(0, 1),
          null === (s = e.ray.intersectTriangle(nV, nW, nk, !1, nO)))
        )
          return;
        let o = e.ray.origin.distanceTo(nO);
        o < e.near ||
          o > e.far ||
          t.push({
            distance: o,
            point: nO.clone(),
            uv: eG.getUV(nO, nV, nk, nW, nj, nq, nX, new m()),
            face: null,
            object: this,
          });
      }
    ...
    class n0 extends t_ {
      ...
      boneTransform(e, t) {
        let i = this.skeleton,
          n = this.geometry;
        (nJ.fromBufferAttribute(n.attributes.skinIndex, e),
          nQ.fromBufferAttribute(n.attributes.skinWeight, e),
          nZ
            .fromBufferAttribute(n.attributes.position, e)
            .applyMatrix4(this.bindMatrix),
          t.set(0, 0, 0));
        for (let e = 0; e < 4; e++) {
          let n = nQ.getComponent(e);
          if (0 !== n) {
            let r = nJ.getComponent(e);
            (n$.multiplyMatrices(i.bones[r].matrixWorld, i.boneInverses[r]),
              t.addScaledVector(nK.copy(nZ).applyMatrix4(n$), n));
          }
        }
        return t.applyMatrix4(this.bindMatrixInverse);
      }
    }
    ((n0.prototype.isSkinnedMesh = !0),
      (class extends eT {
        constructor() {
    ...
    (class extends t_ {
      constructor(e, t, i) {
        (super(e, t),
          (this.instanceMatrix = new e0(new Float32Array(16 * i), 16)),
      ...
      raycast(e, t) {
        let i = this.matrixWorld,
          n = this.count;
        if (
          ((n4.geometry = this.geometry),
          (n4.material = this.material),
          void 0 !== n4.material)
        )
          for (let r = 0; r < n; r++) {
            (this.getMatrixAt(r, n1),
              n3.multiplyMatrices(i, n1),
              (n4.matrixWorld = n3),
              n4.raycast(e, n2));
            for (let e = 0, i = n2.length; e < i; e++) {
              let i = n2[e];
      ...
      setColorAt(e, t) {
        (null === this.instanceColor &&
          (this.instanceColor = new e0(new Float32Array(3 * this.count), 3)),
    ...
    n5.prototype.isLineBasicMaterial = !0;
    let n6 = new S(),
      n8 = new S(),
      n7 = new et(),
      n9 = new ee(),
    ...
    class rt extends eT {
        ...
        if (e.isBufferGeometry)
          if (null === e.index) {
            ...
            for (let e = 1, n = t.count; e < n; e++)
              (n6.fromBufferAttribute(t, e - 1),
                n8.fromBufferAttribute(t, e),
                (i[e] = i[e - 1]),
                (i[e] += n6.distanceTo(n8)));
            e.setAttribute("lineDistance", new e2(i, 1));
          } else
            console.warn(
      ...
      raycast(e, t) {
        ...
        if (
          ...
          re.copy(i.boundingSphere),
          re.applyMatrix4(n),
          (re.radius += r),
          !1 === e.ray.intersectsSphere(re))
        )
          return;
        (n7.copy(n).invert(), n9.copy(e.ray).applyMatrix4(n7));
        ...
        if (i.isBufferGeometry) {
          ...
          if (null !== n) {
            let i = Math.max(0, a.start),
              s = Math.min(n.count, a.start + a.count);
            for (let a = i, p = s - 1; a < p; a += d) {
              let i = n.getX(a),
                s = n.getX(a + 1);
              if (
                (l.fromBufferAttribute(r, i),
                h.fromBufferAttribute(r, s),
                n9.distanceSqToSegment(l, h, u, c) > o)
              )
                continue;
            ...
            let i = Math.max(0, a.start),
              n = Math.min(r.count, a.start + a.count);
            for (let a = i, s = n - 1; a < s; a += d) {
              if (
                (l.fromBufferAttribute(r, a),
                h.fromBufferAttribute(r, a + 1),
                n9.distanceSqToSegment(l, h, u, c) > o)
              )
                continue;
              u.applyMatrix4(this.matrixWorld);
              let i = e.ray.origin.distanceTo(u);
              i < e.near ||
                i > e.far ||
                t.push({
                  distance: i,
          ...
          if (null === e.index) {
            ...
            for (let e = 0, n = t.count; e < n; e += 2)
              (ri.fromBufferAttribute(t, e),
                rn.fromBufferAttribute(t, e + 1),
                (i[e] = 0 === e ? 0 : i[e - 1]),
                (i[e + 1] = i[e] + ri.distanceTo(rn)));
            e.setAttribute("lineDistance", new e2(i, 1));
          } else
            console.warn(
    ...
    let rs = new et(),
      ...
      rl = new q(),
      rh = new S();
    function rc(e, t, i, n, r, a, s) {
      let o = ro.distanceSqToPoint(e);
      if (o < i) {
        let i = new S();
        (ro.closestPointToPoint(e, i), i.applyMatrix4(n));
    ...
    (((class extends eT {
      ...
      raycast(e, t) {
        ...
        if (
          (null === i.boundingSphere && i.computeBoundingSphere(),
          rl.copy(i.boundingSphere),
          rl.applyMatrix4(n),
          (rl.radius += r),
          !1 === e.ray.intersectsSphere(rl))
        )
          return;
        (rs.copy(n).invert(), ro.copy(e.ray).applyMatrix4(rs));
        let s = r / ((this.scale.x + this.scale.y + this.scale.z) / 3),
          o = s * s;
        if (i.isBufferGeometry) {
          let r = i.index,
          ...
          if (null !== r) {
            ...
            for (let a = i; a < l; a++) {
              let i = r.getX(a);
              (rh.fromBufferAttribute(s, i), rc(rh, i, o, n, e, t, this));
            }
          } else {
            let i = Math.max(0, a.start),
              r = Math.min(s.count, a.start + a.count);
            for (let a = i; a < r; a++)
              (rh.fromBufferAttribute(s, a), rc(rh, a, o, n, e, t, this));
          }
        } else
          console.error(
    ...
    (new S(), new S(), new S(), new eG());
    let ru = function (e, t, i) {
      let n, r, a, s, o, l, h;
      i = i || 2;
      let c = t && t.length,
        u = c ? t[0] * i : e.length,
          ...
          (d = (function (e, t, i, n) {
            ...
            for (r = 0, a = t.length; r < a; r++)
              ((s = t[r] * n),
                ...
                (l = rd(e, s, o, n, !1)) === l.next && (l.steiner = !0),
                h.push(
                  (function (e) {
                    let t = e,
                      i = e;
            ...
            for (h.sort(rf), r = 0; r < h.length; r++)
              ((function (e, t) {
                if (
                  (t = (function (e, t) {
                    let i = t,
                    ...
                    do {
                      if (r <= i.y && r >= i.next.y && i.next.y !== i.y) {
                        let e =
                          i.x +
                          ((r - i.y) * (i.next.x - i.x)) / (i.next.y - i.y);
                        if (e <= n && e > a) {
                          if (((a = e), e === n)) {
                            if (r === i.y) return i;
                            ...
                            (u === c &&
                              (i.x > s.x ||
                                (i.x === s.x &&
                                  ((d = s),
                                  (p = i),
                                  0 > rv(d.prev, d, p.prev) &&
                                    0 > rv(p.next, d, d.next)))))) &&
                          ((s = i), (c = u))),
                        (i = i.next));
                    } while (i !== o);
                    return s;
            ...
            if (
              ...
              s
                ? (function (e, t, i, n) {
                    ...
                    for (; d && d.z >= c && p && p.z <= u; ) {
                      if (
                        (d !== e.prev &&
                          d !== e.next &&
                          rg(r.x, r.y, e.x, e.y, a.x, a.y, d.x, d.y) &&
                          rv(d.prev, d, d.next) >= 0) ||
                        ((d = d.prevZ),
                        p !== e.prev &&
                          p !== e.next &&
                          rg(r.x, r.y, e.x, e.y, a.x, a.y, p.x, p.y) &&
                          rv(p.prev, p, p.next) >= 0)
                      )
                        return !1;
                      p = p.nextZ;
                    }
                ...
                : (function (e) {
                    let t = e.prev,
                      i = e.next;
                    if (rv(t, e, i) >= 0) return !1;
                    let n = e.next.next;
                    for (; n !== e.prev; ) {
                      if (
                        rg(t.x, t.y, e.x, e.y, i.x, i.y, n.x, n.y) &&
                        rv(n.prev, n, n.next) >= 0
                      )
                        return !1;
                      n = n.next;
                    }
                          ...
                          if (
                            ...
                            l.next.i !== h.i &&
                              ...
                              ((rw(l, h) &&
                                ...
                                (rv(l.prev, l, h.prev) || rv(l, h.prev, h))) ||
                                (rx(l, h) &&
                                  rv(l.prev, l, l.next) > 0 &&
                                  rv(h.prev, h, h.next) > 0)))
                          ) {
                            let l = rM(o, t);
                            ((o = rp(o, o.next)),
                              (l = rp(l, l.next)),
    ...
    function rd(e, t, i, n, r) {
      ...
      if (
        ...
        for (a = t; a < i; a += n) s = rS(a, e[a], e[a + 1], s);
      else for (a = i - n; a >= t; a -= n) s = rS(a, e[a], e[a + 1], s);
      return (s && rx(s, s.next) && (rE(s), (s = s.next)), s);
    }
    function rp(e, t) {
      if (!e) return e;
      t || (t = e);
      ...
      do
        if (
          ((n = !1),
          !i.steiner && (rx(i, i.next) || 0 === rv(i.prev, i, i.next)))
        ) {
          if ((rE(i), (i = t = i.prev) === i.next)) break;
          n = !0;
        } else i = i.next;
      while (n || i !== t);
      return t;
    ...
    function rw(e, t) {
      return 0 > rv(e.prev, e, e.next)
        ? rv(e, t, e.next) >= 0 && rv(e, e.prev, t) >= 0
        : 0 > rv(e, t, e.prev) || 0 > rv(e, e.next, t);
    }
    function rM(e, t) {
      let i = new rT(e.i, e.x, e.y),
        n = new rT(t.i, t.x, t.y),
        r = e.next,
        a = t.prev;
      return (
        (e.next = t),
    ...
    class rL {
      ...
      static triangulateShape(e, t) {
        ...
        for (let e = 0; e < t.length; e++)
          (n.push(a), (a += t[e].length), rR(i, t[e]));
        let s = ru(i, n);
    ...
    class rC extends ti {
      constructor(e, t) {
        ...
        for (let a = 0, s = e.length; a < s; a++)
          !(function (e) {
            let a,
              ...
              g = void 0 !== t.bevelSize ? t.bevelSize : f - 2,
              v = void 0 !== t.bevelOffset ? t.bevelOffset : 0,
              x = void 0 !== t.bevelSegments ? t.bevelSegments : 3,
              y = t.extrudePath,
              _ = void 0 !== t.UVGenerator ? t.UVGenerator : rP;
            void 0 !== t.amount &&
              (console.warn(
            ...
            let b,
              w = !1;
            (y &&
              ((b = y.getSpacedPoints(u)),
              (w = !0),
              (p = !1),
              (a = y.computeFrenetFrames(u, !1)),
              (s = new S()),
              (o = new S()),
              (l = new S())),
              p || ((x = 0), (f = 0), (g = 0), (v = 0)));
            let M = e.extractPoints(c),
              E = M.shape,
              T = M.holes;
            if (!rL.isClockWise(E)) {
              E = E.reverse();
              for (let e = 0, t = T.length; e < t; e++) {
                let t = T[e];
                rL.isClockWise(t) && (T[e] = t.reverse());
              }
            }
            let L = rL.triangulateShape(E, T),
              A = E;
            for (let e = 0, t = T.length; e < t; e++) {
              let t = T[e];
              E = E.concat(t);
              ...
              if (Math.abs(s * h - o * l) > Number.EPSILON) {
                let u = Math.sqrt(c),
                  ...
                  g =
                    ...
                    (s * h - o * l),
                  v = (n = p + s * g - e.x) * n + (r = f + o * g - e.y) * r;
                if (v <= 2) return new m(n, r);
                a = Math.sqrt(v / 2);
              } else {
                let e = !1;
                (s > Number.EPSILON
            ...
            let I = [];
            for (
              let e = 0, t = A.length, i = t - 1, n = e + 1;
              e < t;
              e++, i++, n++
            )
              (i === t && (i = 0),
            ...
            for (let e = 0, t = T.length; e < t; e++) {
              ...
              for (
                ...
                (n === i && (n = 0),
                  r === i && (r = 0),
                  (z[e] = D(t[e], t[n], t[r])));
              (N.push(z), (O = O.concat(z)));
            }
            for (let e = 0; e < x; e++) {
              let t = e / x,
                i = f * Math.cos((t * Math.PI) / 2),
                n = g * Math.sin((t * Math.PI) / 2) + v;
              for (let e = 0, t = A.length; e < t; e++) {
                let t = R(A[e], I[e], n);
                F(t.x, t.y, -i);
              }
            ...
            function H(e, t) {
              ...
              for (; --r >= 0; ) {
                let a = r,
                  s = r - 1;
                s < 0 && (s = e.length - 1);
                for (let e = 0, r = u + 2 * x; e < r; e++) {
                  let r = C * e,
                    o = C * (e + 1);
                  !(function (e, t, r, a) {
                    (G(e), G(t), G(a), G(t), G(r), G(a));
                    let s = n.length / 3,
                      o = _.generateSideWallUV(
                        i,
                        n,
                        s - 6,
                        s - 3,
            ...
            function U(e, t, r) {
              (G(e), G(t), G(r));
              let a = n.length / 3,
                s = _.generateTopUV(i, n, a - 3, a - 2, a - 1);
              (V(s[0]), V(s[1]), V(s[2]));
            }
            function G(e) {
              (n.push(h[3 * e + 0]),
        ...
        (this.setAttribute("position", new e2(n, 3)),
          this.setAttribute("uv", new e2(r, 2)),
          this.computeVertexNormals());
      }
      toJSON() {
        let e = ti.prototype.toJSON.call(this);
    ...
    let rP = {
      ...
      generateSideWallUV: function (e, t, i, n, r, a) {
        let s = t[3 * i],
          ...
          v = t[3 * a + 1],
          x = t[3 * a + 2];
        return 0.01 > Math.abs(o - c)
          ? [new m(s, 1 - l), new m(h, 1 - u), new m(d, 1 - f), new m(g, 1 - x)]
          : [
              new m(o, 1 - l),
              new m(c, 1 - u),
              new m(p, 1 - f),
      ...
      constructor(e, t = 12) {
        ...
        function l(e) {
          let s = n.length / 3,
            ...
            h = l.shape,
            c = l.holes;
          !1 === rL.isClockWise(h) && (h = h.reverse());
          for (let e = 0, t = c.length; e < t; e++) {
            let t = c[e];
            !0 === rL.isClockWise(t) && (c[e] = t.reverse());
          }
          let u = rL.triangulateShape(h, c);
          for (let e = 0, t = c.length; e < t; e++) {
            let t = c[e];
            h = h.concat(t);
          }
        ...
        (this.setIndex(i),
          this.setAttribute("position", new e2(n, 3)),
          this.setAttribute("normal", new e2(r, 3)),
          this.setAttribute("uv", new e2(a, 2)));
      }
      toJSON() {
        let e = ti.prototype.toJSON.call(this);
        return (function (e, t) {
    ...
    class rI extends ti {
      constructor(
        ...
        for (let d = 0; d <= i; d++) {
          ...
          0 == d && 0 == a
            ? (x = 0.5 / t)
            : d == i && o == Math.PI && (x = -0.5 / t);
          for (let i = 0; i <= t; i++) {
            const o = i / t;
            ((c.x = -e * Math.cos(n + o * r) * Math.sin(a + v * s)),
              (c.y = e * Math.cos(a + v * s)),
              (c.z = e * Math.sin(n + o * r) * Math.sin(a + v * s)),
              p.push(c.x, c.y, c.z),
              u.copy(c).normalize(),
              f.push(u.x, u.y, u.z),
              m.push(o + x, 1 - v),
    ...
    ((rN.prototype.isMeshStandardMaterial = !0),
      (class extends rN {
        constructor(e) {
          (super(),
            ...
            Object.defineProperty(this, "ior", {
              ...
              set: function (e) {
                this.reflectivity = d((2.5 * (e - 1)) / (e + 1), 0, 1);
              },
            }),
            (this.sheen = null),
            (this.transmission = 0),
        ...
        copy(e) {
          return (
            ...
            (this.reflectivity = e.reflectivity),
            e.sheen
              ? (this.sheen = (this.sheen || new eJ()).copy(e.sheen))
              : (this.sheen = null),
    ...
    let rz = {
      ...
      flattenJSON: function (e, t, i, n) {
        ...
        if (void 0 !== s)
          if (Array.isArray(s))
            ...
            do
              (void 0 !== (s = a[n]) &&
                (t.push(a.time), s.toArray(i, i.length)),
                (a = e[r++]));
            while (void 0 !== a);
          else
            do
              (void 0 !== (s = a[n]) && (t.push(a.time), i.push(s)),
                (a = e[r++]));
            while (void 0 !== a);
      },
      subclip: function (e, t, i, n, r = 30) {
        ...
        for (let e = 0; e < a.tracks.length; ++e) {
          ...
          0 !== l.length &&
            ((t.times = rz.convertArray(l, t.times.constructor)),
            (t.values = rz.convertArray(h, t.values.constructor)),
            s.push(t));
        }
        a.tracks = s;
        let o = 1 / 0;
        ...
        for (let t = 0; t < r; ++t) {
          ...
          if (a <= r.times[0]) {
            ...
            let e = r.createInterpolant(),
              t = l,
              i = h - l;
            (e.evaluate(a), (n = rz.arraySlice(e.resultBuffer, t, i)));
          }
          "quaternion" === s &&
            new M().fromArray(n).normalize().conjugate().toArray(n);
          let p = o.times.length;
          for (let e = 0; e < p; ++e) {
            let t = e * u + c;
            if ("quaternion" === s)
              M.multiplyQuaternionsFlat(o.values, t, n, 0, o.values, t);
            else {
              let e = u - 2 * c;
    ...
    ((rO.prototype.beforeStart_ = rO.prototype.copySampleValue_),
      (rO.prototype.afterEnd_ = rO.prototype.copySampleValue_));
    class rB extends rO {
      constructor(e, t, i, n) {
        (super(e, t, i, n),
          (this._weightPrev = -0),
      ...
      interpolate_(e, t, i, n) {
        let r = this.resultBuffer,
          ...
          y = d * m - d * f;
        for (let e = 0; e !== s; ++e)
          r[e] = g * a[h + e] + v * a[l + e] + x * a[o + e] + y * a[c + e];
        return r;
      }
    }
    class rH extends rO {
    ...
    class rU {
      constructor(e, t, i, n) {
        ...
        ((this.name = e),
          (this.times = rz.convertArray(t, this.TimeBufferType)),
          (this.values = rz.convertArray(i, this.ValueBufferType)),
      ...
      static toJSON(e) {
        ...
        if (i.toJSON !== this.toJSON) t = i.toJSON(e);
          ...
          t = {
            name: e.name,
            times: rz.convertArray(e.times, Array),
            values: rz.convertArray(e.values, Array),
          };
      ...
      trim(e, t) {
        ...
        if ((++a, 0 !== r || a !== n)) {
          ...
          ((this.times = rz.arraySlice(i, r, a)),
            (this.values = rz.arraySlice(this.values, r * e, a * e)));
        }
        return this;
      }
      validate() {
      ...
      optimize() {
        let e = rz.arraySlice(this.times),
          t = rz.arraySlice(this.values),
          i = this.getValueSize(),
        ...
        return (
          a !== e.length
            ? ((this.times = rz.arraySlice(e, 0, a)),
              (this.values = rz.arraySlice(t, 0, a * i)))
            : ((this.times = e), (this.values = t)),
          this
        );
      }
      clone() {
        let e = rz.arraySlice(this.times, 0),
          t = rz.arraySlice(this.values, 0),
    ...
    ((rU.prototype.TimeBufferType = Float32Array),
      ...
      (rU.prototype.DefaultInterpolation = 2301));
    class rG extends rU {}
    ((rG.prototype.ValueTypeName = "bool"),
      (rG.prototype.ValueBufferType = Array),
      (rG.prototype.DefaultInterpolation = 2300),
      (rG.prototype.InterpolantFactoryMethodLinear = void 0),
      (rG.prototype.InterpolantFactoryMethodSmooth = void 0));
    class rV extends rU {}
    rV.prototype.ValueTypeName = "color";
    class rk extends rU {}
    rk.prototype.ValueTypeName = "number";
    class rW extends rO {
      constructor(e, t, i, n) {
        super(e, t, i, n);
      }
    ...
    ((rj.prototype.ValueTypeName = "quaternion"),
      (rj.prototype.DefaultInterpolation = 2301),
      (rj.prototype.InterpolantFactoryMethodSmooth = void 0));
    class rq extends rU {}
    ((rq.prototype.ValueTypeName = "string"),
      (rq.prototype.ValueBufferType = Array),
      (rq.prototype.DefaultInterpolation = 2300),
      (rq.prototype.InterpolantFactoryMethodLinear = void 0),
      (rq.prototype.InterpolantFactoryMethodSmooth = void 0));
    class rX extends rU {}
    rX.prototype.ValueTypeName = "vector";
    class rY {
          ...
          t.push(
            (function (e) {
              ...
              if (void 0 === e.times) {
                let t = [],
                  i = [];
                (rz.flattenJSON(e.keys, t, i, "value"),
                  (e.times = t),
                  (e.values = i));
              }
      ...
      static toJSON(e) {
        ...
        for (let e = 0, n = i.length; e !== n; ++e) t.push(rU.toJSON(i[e]));
        return n;
      }
      static CreateFromMorphTargetSequence(e, t, i, n) {
        ...
        for (let e = 0; e < r; e++) {
          ...
          let l = rz.getKeyframeOrder(s);
          ((s = rz.sortedArray(s, 1, l)),
            (o = rz.sortedArray(o, 1, l)),
            n || 0 !== s[0] || (s.push(r), o.push(o[0])),
            a.push(
              new rk(".morphTargetInfluences[" + t[e].name + "]", s, o).scale(
                1 / i,
              ),
            ));
        }
      ...
      static CreateClipsFromMorphTargetSequences(e, t, i) {
        ...
        let a = [];
        for (let e in n)
          a.push(this.CreateFromMorphTargetSequence(e, n[e], t, i));
        return a;
      }
          ...
          if (r && 0 !== r.length)
            if (r[0].morphTargets) {
              ...
              for (let i in t) {
                ...
                n.push(new rk(".morphTargetInfluence[" + i + "]", t, a));
              }
              o = t.length * (a || 1);
            } else {
              let a = ".bones[" + t[e].name + "]";
              (i(rX, a + ".position", r, "pos", n),
                i(rj, a + ".quaternion", r, "rot", n),
                i(rX, a + ".scale", r, "scl", n));
            }
        }
    ...
    class r$ extends rQ {
      ...
      load(e, t, i, n) {
        ...
        if (void 0 !== rK[e])
          return void rK[e].push({ onLoad: t, onProgress: i, onError: n });
        ...
        if (o) {
          ...
          try {
            let n,
              r = (this.responseType || "").toLowerCase();
            switch (r) {
              case "arraybuffer":
              case "blob":
                let o = new Uint8Array(s.length);
                for (let e = 0; e < s.length; e++) o[e] = s.charCodeAt(e);
                n = "blob" === r ? new Blob([o.buffer], { type: i }) : o.buffer;
                break;
              case "document":
                n = new DOMParser().parseFromString(s, i);
                break;
              case "json":
                n = JSON.parse(s);
                break;
          ...
          for (let s in ((rK[e] = []),
          rK[e].push({ onLoad: t, onProgress: i, onError: n }),
          ...
          r.addEventListener(
            ...
            function (t) {
              let i = this.response,
                n = rK[e];
              if ((delete rK[e], 200 === this.status || 0 === this.status)) {
                (0 === this.status &&
          ...
          this.requestHeader))
            r.setRequestHeader(s, this.requestHeader[s]);
          r.send(null);
        }
    ...
    class r2 {
      ...
      computeFrenetFrames(e, t) {
        ...
        for (let t = 0; t <= e; t++) {
          let i = t / e;
          ((n[t] = this.getTangentAt(i, new S())), n[t].normalize());
        }
        ((r[0] = new S()), (a[0] = new S()));
    ...
    class at extends r2 {
      ...
      getPoint(e, t = new S()) {
        ...
        (this.closed
          ...
          this.closed || o > 0
            ? (i = r[(o - 1) % a])
            : (r8.subVectors(r[0], r[1]).add(r[0]), (i = r8)));
        let h = r[o % a],
          c = r[(o + 1) % a];
        if (
          (this.closed || o + 2 < a
            ? (n = r[(o + 2) % a])
            : (r8.subVectors(r[a - 1], r[a - 2]).add(r[a - 1]), (n = r8)),
          ...
          (r < 1e-4 && (r = 1),
            t < 1e-4 && (t = r),
            a < 1e-4 && (a = r),
            r7.initNonuniformCatmullRom(i.x, h.x, c.x, n.x, t, r, a),
            r9.initNonuniformCatmullRom(i.y, h.y, c.y, n.y, t, r, a),
            ae.initNonuniformCatmullRom(i.z, h.z, c.z, n.z, t, r, a));
        } else
          "catmullrom" === this.curveType &&
            (r7.initCatmullRom(i.x, h.x, c.x, n.x, this.tension),
            r9.initCatmullRom(i.y, h.y, c.y, n.y, this.tension),
            ae.initCatmullRom(i.z, h.z, c.z, n.z, this.tension));
        return (t.set(r7.calc(l), r9.calc(l), ae.calc(l)), t);
      }
      copy(e) {
    ...
    at.prototype.isCatmullRomCurve3 = !0;
    class aa extends r2 {
    ...
    class as extends r2 {
      constructor(e = new S(), t = new S(), i = new S(), n = new S()) {
        (super(),
      ...
      getPoint(e, t = new S()) {
        ...
        return (
          t.set(
            ar(e, i.x, n.x, r.x, a.x),
            ar(e, i.y, n.y, r.y, a.y),
            ar(e, i.z, n.z, r.z, a.z),
          ),
          t
        );
      }
    ...
    class al extends r2 {
      ...
      getPoint(e, t = new m()) {
        let i = this.v0,
          n = this.v1,
          r = this.v2;
        return (t.set(an(e, i.x, n.x, r.x), an(e, i.y, n.y, r.y)), t);
      }
      copy(e) {
        return (
          super.copy(e),
    ...
    class ac extends r2 {
      ...
      getPoint(e, t = new m()) {
        ...
        return (t.set(ai(a, s.x, o.x, l.x, h.x), ai(a, s.y, o.y, l.y, h.y)), t);
      }
      copy(e) {
        (super.copy(e), (this.points = []));
        for (let t = 0, i = e.points.length; t < i; t++) {
    ...
    class ad extends r2 {
      ...
      closePath() {
        ...
        e.equals(t) || this.curves.push(new ao(t, e));
      }
      getPoint(e) {
      ...
      fromJSON(e) {
        ...
        for (let t = 0, i = e.curves.length; t < i; t++) {
          let i = e.curves[t];
          this.curves.push(new au[i.type]().fromJSON(i));
        }
        return this;
      }
    }
    class ap extends ad {
      ...
      lineTo(e, t) {
        let i = new ao(this.currentPoint.clone(), new m(e, t));
        return (this.curves.push(i), this.currentPoint.set(e, t), this);
      }
      quadraticCurveTo(e, t, i, n) {
        let r = new al(this.currentPoint.clone(), new m(e, t), new m(i, n));
      ...
      splineThru(e) {
        let t = new ac([this.currentPoint.clone()].concat(e));
        return (
          this.curves.push(t),
    ...
    class af extends ap {
      constructor(e) {
        (super(e), (this.uuid = u()), (this.type = "Shape"), (this.holes = []));
      }
      getPointsHoles(e) {
        let t = [];
      ...
      fromJSON(e) {
        ...
        for (let t = 0, i = e.holes.length; t < i; t++) {
          let i = e.holes[t];
          this.holes.push(new ap().fromJSON(i));
        }
        return this;
      }
    }
    ...
    ((am.prototype.isLight = !0),
      (class extends am {
        constructor(e, t, i) {
          (super(e, i),
            (this.type = "HemisphereLight"),
            this.position.copy(eT.DefaultUp),
            this.updateMatrix(),
            (this.groundColor = new eJ(t)));
        }
        copy(e) {
          return (
            am.prototype.copy.call(this, e),
    ...
    class ay {
      ...
      updateMatrices(e) {
        let t = this.camera,
          i = this.matrix;
        (av.setFromMatrixPosition(e.matrixWorld),
          t.position.copy(av),
          ax.setFromMatrixPosition(e.target.matrixWorld),
          t.lookAt(ax),
          t.updateMatrixWorld(),
          ag.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse),
          this._frustum.setFromProjectionMatrix(ag),
    ...
    class a_ extends ay {
      constructor() {
        (super(new tL(50, 1, 0.5, 500)), (this.focus = 1));
      }
      updateMatrices(e) {
        let t = this.camera,
          i = 2 * c * e.angle * this.focus,
    ...
    ((a_.prototype.isSpotLightShadow = !0),
      (class extends am {
    ...
    class aS extends ay {
      ...
      updateMatrices(e, t = 0) {
        ...
        (r !== i.far && ((i.far = r), i.updateProjectionMatrix()),
          ...
          i.position.copy(aw),
          aM.copy(i.position),
          aM.add(this._cubeDirections[t]),
          i.up.copy(this._cubeUps[t]),
          i.lookAt(aM),
          i.updateMatrixWorld(),
          n.makeTranslation(-aw.x, -aw.y, -aw.z),
          ab.multiplyMatrices(i.projectionMatrix, i.matrixWorldInverse),
          this._frustum.setFromProjectionMatrix(ab));
      }
    }
    ((aS.prototype.isPointLightShadow = !0),
      (class extends am {
    ...
    aE.prototype.isOrthographicCamera = !0;
    class aT extends ay {
      constructor() {
        super(new aE(-5, 5, 5, -5, 0.5, 500));
      }
    }
    ((aT.prototype.isDirectionalLightShadow = !0),
      (class extends am {
        constructor(e, t) {
          (super(e, t),
    ...
    class aL {
      ...
      getAt(e, t) {
        ...
        return (
          ...
          t.addScaledVector(a[4], i * n * 1.092548),
          t.addScaledVector(a[5], n * r * 1.092548),
          t.addScaledVector(a[6], 0.315392 * (3 * r * r - 1)),
          t.addScaledVector(a[7], i * r * 1.092548),
          t.addScaledVector(a[8], 0.546274 * (i * i - n * n)),
          t
        );
      }
      getIrradianceAt(e, t) {
        ...
        return (
          ...
          t.addScaledVector(a[4], 0.858086 * i * n),
          t.addScaledVector(a[5], 0.858086 * n * r),
          t.addScaledVector(a[6], 0.743125 * r * r - 0.247708),
          t.addScaledVector(a[7], 0.858086 * i * r),
          t.addScaledVector(a[8], 0.429043 * (i * i - n * n)),
          t
        );
      }
      add(e) {
        ...
        load(e, t, i, n) {
          ...
          ((s.credentials =
            ...
            fetch(e, s)
              ...
              .then(function (i) {
                (rZ.add(e, i), t && t(i), r.manager.itemEnd(e));
              })
              .catch(function (t) {
    ...
    class aC {
      ...
      toShapes(e, t) {
        ...
        let l = rL.isClockWise,
          h = this.subPaths;
        if (0 === h.length) return [];
        if (!0 === t) return o(h);
        let c = [];
        if (1 === h.length)
          return ((n = h[0]), ((r = new af()).curves = n.curves), c.push(r), c);
        let u = !l(h[0].getPoints());
        u = e ? !u : u;
        let d = [],
          p = [],
          f = [],
        ...
        for (let t = 0, r = h.length; t < r; t++)
          ((i = l((a = (n = h[t]).getPoints()))),
            (i = e ? !i : i)
              ? (!u && p[m] && m++,
                (p[m] = { s: new af(), p: a }),
                (p[m].s.curves = n.curves),
                u && m++,
                (f[m] = []))
              : f[m].push({ h: n, p: a[0] }));
        if (!p[0]) return o(h);
            ...
            for (let r = 0; r < n.length; r++) {
              ...
              for (let n = 0; n < p.length; n++)
                (function (e, t) {
                  ...
                  (i !== n && t.push({ froms: i, tos: n, hole: r }),
    ...
    (class {
      ...
      generateShapes(e, t = 100) {
                      ...
                      switch (e[r++]) {
                        ...
                        case "b":
                          ((o = e[r++] * t + i),
                            ...
                            (u = e[r++] * t + i),
                            (d = e[r++] * t + n),
                            f.bezierCurveTo(h, c, u, d, o, l));
                      }
                  }
                  return { offsetX: p.ha * t, path: f };
                })(t, r, o, l, i);
        ...
        for (let e = 0, t = n.length; e < t; e++)
          Array.prototype.push.apply(i, n[e].toShapes());
        return i;
      }
    }).prototype.isFont = !0;
    class aP extends rQ {
    ...
    class aN {
      ...
      _select(e, t, i, n, r) {
        if (n >= 0.5) for (let n = 0; n !== r; ++n) e[t + n] = e[i + n];
      }
      _slerp(e, t, i, n) {
      ...
      _slerpAdditive(e, t, i, n, r) {
        ...
        (M.multiplyQuaternionsFlat(e, a, e, t, e, i),
          M.slerpFlat(e, t, e, t, e, a, n));
      }
      _lerp(e, t, i, n, r) {
        let a = 1 - n;
        for (let s = 0; s !== r; ++s) {
    ...
    let az = "\\[\\]\\.:\\/",
      ...
      aF = RegExp(
        "^" +
          /((?:WC+[\/:])*)/.source.replace("WC", aB) +
          /(WCOD+)?/.source.replace("WCOD", aH) +
          /(?:\.(WC+)(?:\[(.+)\])?)?/.source.replace("WC", aB) +
          /\.(WC+)(?:\[(.+)\])?/.source.replace("WC", aB) +
          "$",
      ),
      aU = ["material", "materials", "bones"];
    class aG {
      constructor(e, t, i) {
        ((this.path = t),
          (this.parsedPath = i || aG.parseTrackName(t)),
          (this.node = aG.findNode(e, this.parsedPath.nodeName) || e),
          (this.rootNode = e),
      ...
      bind() {
        ...
        if (
          (e ||
            ((e = aG.findNode(this.rootNode, t.nodeName) || this.rootNode),
            (this.node = e)),
      ...
      (class {
        ...
        add() {
          ...
          for (let h = 0, c = arguments.length; h !== c; ++h) {
            ...
            if (void 0 === d) {
              ((d = o++), (t[u] = d), e.push(c));
              for (let e = 0; e !== a; ++e) r[e].push(new aG(c, i[e], n[e]));
            } else if (d < l) {
              s = e[d];
              let o = --l,
                h = e[o];
              ((t[h.uuid] = d), (e[d] = h), (t[u] = o), (e[o] = c));
              for (let e = 0; e !== a; ++e) {
                let t = r[e],
                  a = t[o],
                  s = t[d];
                ((t[d] = a),
                  void 0 === s && (s = new aG(c, i[e], n[e])),
                  (t[o] = s));
              }
            } else
              e[d] !== s &&
    ...
    class aV {
      ...
      _update(e, t, i, n) {
        ...
        if (s > 0) {
          ...
          if (2501 === this.blendMode)
            for (let i = 0, n = e.length; i !== n; ++i)
              (e[i].evaluate(a), t[i].accumulateAdditive(s));
          else
            for (let i = 0, r = e.length; i !== r; ++i)
              (e[i].evaluate(a), t[i].accumulate(n, s));
        }
      }
      _updateWeight(e) {
        let t = 0;
      ...
      _setEndings(e, t, i) {
        ...
        i
          ...
          : (e
              ? (n.endingStart = this.zeroSlopeAtStart ? 2401 : 2400)
              : (n.endingStart = 2402),
            t
              ? (n.endingEnd = this.zeroSlopeAtEnd ? 2401 : 2400)
              : (n.endingEnd = 2402));
      }
    ...
    (class extends o {
      ...
      clipAction(e, t, i) {
        let n = t || this._root,
          r = n.uuid,
          a = "string" == typeof e ? rY.findByName(n, e) : e,
          s = null !== a ? a.uuid : e,
          o = this._actionsByClip[s],
          l = null;
        if (
          (void 0 === i && (i = null !== a ? a.blendMode : 2500), void 0 !== o)
        ) {
        ...
        let h = new aV(this, a, t, i);
        return (this._bindAction(h, l), this._addInactiveAction(h, s, r), h);
      }
      existingAction(e, t) {
        let i = t || this._root,
          n = i.uuid,
          r = "string" == typeof e ? rY.findByName(i, e) : e,
          a = r ? r.uuid : e,
    ...
    let aW = new m();
    class aj {
      constructor(e = new m(Infinity, Infinity), t = new m(-1 / 0, -1 / 0)) {
        ((this.min = e), (this.max = t));
      }
      set(e, t) {
        return (this.min.copy(e), this.max.copy(t), this);
      ...
      setFromCenterAndSize(e, t) {
        let i = aW.copy(t).multiplyScalar(0.5);
        return (this.min.copy(e).sub(i), this.max.copy(e).add(i), this);
      }
      clone() {
        return new this.constructor().copy(this);
      ...
      distanceToPoint(e) {
        return aW.copy(e).clamp(this.min, this.max).sub(e).length();
      }
      intersect(e) {
    ...
    let aY = new S(),
      aZ = new et(),
      aJ = new et();
    new Int32Array(new Float32Array(1).buffer);
    let aQ = new eQ({ side: 1, depthWrite: !1, depthTest: !1 });
    new t_(new tw(), aQ);
    ((r2.create = function (e, t) {
      return (
        console.log("THREE.Curve.create() has been deprecated"),
        (e.prototype = Object.create(r2.prototype)),
        (e.prototype.constructor = e),
        (e.prototype.getPoint = t),
        e
      );
    }),
      (ap.prototype.fromPoints = function (e) {
        return (
          console.warn(
      ...
      (class extends rr {
        constructor(e = 10, t = 10, i = 4473924, n = 8947848) {
          ...
          const h = new ti();
          (h.setAttribute("position", new e2(o, 3)),
            h.setAttribute("color", new e2(l, 3)),
            super(h, new n5({ vertexColors: !0, toneMapped: !1 })),
      ...
      (class extends rr {
        constructor(e) {
          ...
          (i.setAttribute("position", new e2(n, 3)),
            i.setAttribute("color", new e2(r, 3)),
            super(
              i,
              new n5({
                vertexColors: !0,
        ...
        updateMatrixWorld(e) {
          ...
          aJ.copy(this.root.matrixWorld).invert();
          for (let e = 0, i = 0; e < t.length; e++) {
            let r = t[e];
            r.parent &&
              r.parent.isBone &&
              (aZ.multiplyMatrices(aJ, r.matrixWorld),
              aY.setFromMatrixPosition(aZ),
              n.setXYZ(i, aY.x, aY.y, aY.z),
              aZ.multiplyMatrices(aJ, r.parent.matrixWorld),
              aY.setFromMatrixPosition(aZ),
              n.setXYZ(i + 1, aY.x, aY.y, aY.z),
              (i += 2));
          }
      ...
      (rQ.prototype.extractUrlBase = function (e) {
        return (
          console.warn(
      ...
      (aj.prototype.center = function (e) {
        return (
          console.warn(
      ...
      (aj.prototype.empty = function () {
        return (
          console.warn("THREE.Box2: .empty() has been renamed to .isEmpty()."),
          this.isEmpty()
        );
      }),
      (aj.prototype.isIntersectionBox = function (e) {
        return (
          console.warn(
      ...
      (aj.prototype.size = function (e) {
        return (
          console.warn("THREE.Box2: .size() has been renamed to .getSize()."),
          this.getSize(e)
        );
      }),
      (L.prototype.center = function (e) {
        return (
          console.warn(
      ...
      (L.prototype.isIntersectionBox = function (e) {
        return (
          console.warn(
      ...
      (L.prototype.isIntersectionSphere = function (e) {
        return (
          console.warn(
      ...
      (tN.prototype.setFromMatrix = function (e) {
        return (
          console.warn(
      ...
      (class {
        ...
        closestPointToPointParameter(e, t) {
          (aq.subVectors(e, this.start), aX.subVectors(this.end, this.start));
          let i = aX.dot(aX),
            n = aX.dot(aq) / i;
          return (t && (n = d(n, 0, 1)), n);
        }
      ...
      (g.prototype.flattenToArrayOffset = function (e, t) {
        return (
          console.warn(
      ...
      (g.prototype.multiplyVector3Array = function () {
        console.error(
          "THREE.Matrix3: .multiplyVector3Array() has been removed.",
        );
      }),
      (g.prototype.applyToBufferAttribute = function (e) {
        return (
          console.warn(
      ...
      (g.prototype.applyToVector3Array = function () {
        console.error(
          "THREE.Matrix3: .applyToVector3Array() has been removed.",
        );
      }),
      (g.prototype.getInverse = function (e) {
        return (
          console.warn(
      ...
      (et.prototype.extractPosition = function (e) {
        return (
          console.warn(
      ...
      (et.prototype.flattenToArrayOffset = function (e, t) {
        return (
          console.warn(
      ...
      (et.prototype.setRotationFromQuaternion = function (e) {
        return (
          console.warn(
      ...
      (et.prototype.multiplyVector3 = function (e) {
        return (
          console.warn(
      ...
      (et.prototype.multiplyVector4 = function (e) {
        return (
          console.warn(
      ...
      (et.prototype.rotateAxis = function (e) {
        (console.warn(
          "THREE.Matrix4: .rotateAxis() has been removed. Use Vector3.transformDirection( matrix ) instead.",
        ),
          e.transformDirection(this));
      }),
      (et.prototype.crossVector = function (e) {
        return (
          console.warn(
      ...
      (et.prototype.applyToBufferAttribute = function (e) {
        return (
          console.warn(
      ...
      (et.prototype.makeFrustum = function (e, t, i, n, r, a) {
        return (
          console.warn(
      ...
      (et.prototype.getInverse = function (e) {
        return (
          console.warn(
      ...
      (eC.prototype.isIntersectionLine = function (e) {
        return (
          console.warn(
      ...
      (eG.prototype.barycoordFromPoint = function (e, t) {
        return (
          console.warn(
      ...
      (eG.prototype.midpoint = function (e) {
        return (
          console.warn(
      ...
      (eG.barycoordFromPoint = function (e, t, i, n, r) {
        return (
          console.warn(
            "THREE.Triangle: .barycoordFromPoint() has been renamed to .getBarycoord().",
          ),
          eG.getBarycoord(e, t, i, n, r)
        );
      }),
      (eG.normal = function (e, t, i, n) {
        return (
          console.warn(
            "THREE.Triangle: .normal() has been renamed to .getNormal().",
          ),
          eG.getNormal(e, t, i, n)
        );
      }),
      (af.prototype.extractAllPoints = function (e) {
        return (
          console.warn(
      ...
      (af.prototype.extrude = function (e) {
        return (
          console.warn(
      ...
      (af.prototype.makeGeometry = function (e) {
        return (
          console.warn(
      ...
      (m.prototype.fromAttribute = function (e, t, i) {
        return (
          console.warn(
      ...
      (S.prototype.getPositionFromMatrix = function (e) {
        return (
          console.warn(
      ...
      (S.prototype.getScaleFromMatrix = function (e) {
        return (
          console.warn(
      ...
      (S.prototype.getColumnFromMatrix = function (e, t) {
        return (
          console.warn(
      ...
      (S.prototype.applyProjection = function (e) {
        return (
          console.warn(
      ...
      (S.prototype.fromAttribute = function (e, t, i) {
        return (
          console.warn(
      ...
      (S.prototype.distanceToManhattan = function (e) {
        return (
          console.warn(
      ...
      (b.prototype.fromAttribute = function (e, t, i) {
        return (
          console.warn(
      ...
      (eT.prototype.getChildByName = function (e) {
        return (
          console.warn(
      ...
      (eT.prototype.renderDepth = function () {
        console.warn(
          "THREE.Object3D: .renderDepth has been removed. Use .renderOrder, instead.",
        );
      }),
      (eT.prototype.translate = function (e, t) {
        return (
          console.warn(
      ...
      (eT.prototype.getWorldRotation = function () {
        console.error(
          "THREE.Object3D: .getWorldRotation() has been removed. Use THREE.Object3D.getWorldQuaternion( target ) instead.",
        );
      }),
      (eT.prototype.applyMatrix = function (e) {
        return (
          console.warn(
      ...
      (t_.prototype.setDrawMode = function () {
        console.error(
      ...
      (n0.prototype.initBones = function () {
        console.error("THREE.SkinnedMesh: initBones() has been removed.");
      }),
      (tL.prototype.setLens = function (e, t) {
        (console.warn(
      ...
      Object.defineProperties(e0.prototype, {
        length: {
          get: function () {
            return (
              console.warn(
      ...
      (e0.prototype.setDynamic = function (e) {
        return (
          console.warn(
      ...
      (e0.prototype.copyIndicesArray = function () {
        console.error(
          "THREE.BufferAttribute: .copyIndicesArray() has been removed.",
        );
      }),
      (e0.prototype.setArray = function () {
        console.error(
      ...
      (ti.prototype.addAttribute = function (e, t) {
        ...
        (t && t.isBufferAttribute) || (t && t.isInterleavedBufferAttribute))
          ...
          : (console.warn(
            ...
            this.setAttribute(e, new e0(arguments[1], arguments[2])));
      }),
      ...
      (nD.prototype.setDynamic = function (e) {
        return (
          console.warn(
      ...
      (nD.prototype.setArray = function () {
        console.error(
          "THREE.InterleavedBuffer: .setArray has been removed. Use BufferGeometry .setAttribute to replace/resize attribute buffers",
        );
      }),
      (rC.prototype.getArrays = function () {
        console.error("THREE.ExtrudeGeometry: .getArrays() has been removed.");
      }),
      (rC.prototype.addShapeList = function () {
        console.error(
          "THREE.ExtrudeGeometry: .addShapeList() has been removed.",
        );
      }),
      (rC.prototype.addShape = function () {
        console.error("THREE.ExtrudeGeometry: .addShape() has been removed.");
      }),
      (nP.prototype.dispose = function () {
        console.error("THREE.Scene: .dispose() has been removed.");
      }),
      (ak.prototype.onUpdate = function () {
        return (
          console.warn(
      ...
      Object.defineProperties(ek.prototype, {
        wrapAround: {
          get: function () {
      ...
      (nA.prototype.clearTarget = function (e, t, i, n) {
        (console.warn(
      ...
      (nA.prototype.animate = function (e) {
        (console.warn(
          "THREE.WebGLRenderer: .animate() is now .setAnimationLoop().",
        ),
          this.setAnimationLoop(e));
      }),
      (nA.prototype.getCurrentRenderTarget = function () {
        return (
          console.warn(
      ...
      (nA.prototype.getMaxAnisotropy = function () {
        return (
          console.warn(
      ...
      (nA.prototype.getPrecision = function () {
        return (
          console.warn(
      ...
      (nA.prototype.resetGLState = function () {
        return (
          console.warn(
      ...
      (nA.prototype.supportsFloatTextures = function () {
        return (
          console.warn(
      ...
      (nA.prototype.supportsHalfFloatTextures = function () {
        return (
          console.warn(
      ...
      (nA.prototype.supportsStandardDerivatives = function () {
        return (
          console.warn(
      ...
      (nA.prototype.supportsCompressedTextureS3TC = function () {
        return (
          console.warn(
      ...
      (nA.prototype.supportsCompressedTexturePVRTC = function () {
        return (
          console.warn(
      ...
      (nA.prototype.supportsBlendMinMax = function () {
        return (
          console.warn(
      ...
      (nA.prototype.supportsVertexTextures = function () {
        return (
          console.warn(
      ...
      (nA.prototype.supportsInstancedArrays = function () {
        return (
          console.warn(
      ...
      (nA.prototype.enableScissorTest = function (e) {
        (console.warn(
          "THREE.WebGLRenderer: .enableScissorTest() is now .setScissorTest().",
        ),
          this.setScissorTest(e));
      }),
      (nA.prototype.initMaterial = function () {
      ...
      (nA.prototype.updateShadowMap = function () {
        console.warn(
          "THREE.WebGLRenderer: .updateShadowMap() has been removed.",
        );
      }),
      (nA.prototype.setFaceCulling = function () {
        console.warn(
          "THREE.WebGLRenderer: .setFaceCulling() has been removed.",
        );
      }),
      (nA.prototype.allocTextureUnit = function () {
        console.warn(
          "THREE.WebGLRenderer: .allocTextureUnit() has been removed.",
        );
      }),
      (nA.prototype.setTexture = function () {
        console.warn("THREE.WebGLRenderer: .setTexture() has been removed.");
      }),
      (nA.prototype.setTexture2D = function () {
        console.warn("THREE.WebGLRenderer: .setTexture2D() has been removed.");
      }),
      (nA.prototype.setTextureCube = function () {
        console.warn(
          "THREE.WebGLRenderer: .setTextureCube() has been removed.",
        );
      }),
      (nA.prototype.getActiveMipMapLevel = function () {
        return (
          console.warn(
      ...
      (tA.prototype.clear = function (e, t, i, n) {
        return (
          console.warn(
      ...
      (v.loadTexture = function (e, t, i, n) {
        console.warn(
      ...
      (v.loadTextureCube = function (e, t, i, n) {
        console.warn(
    ...
    let aK = () => {
      ...
      return (
        (0, a.useEffect)(() => {
          if (!e.current) return;
          let t = new nP(),
            i = new tL(75, window.innerWidth / window.innerHeight, 0.1, 1e3),
            n = new nA({ antialias: !0 }),
            r = new aD();
          (n.setSize(window.innerWidth, window.innerHeight),
            e.current.appendChild(n.domElement));
          let a = {
              u_time: { type: "f", value: 1 },
              u_resolution: { type: "v2", value: new m() },
              u_mouse: { type: "v2", value: new m() },
            },
            s = new t_(
              new rI(15, 64, 64),
              new tE({
      ...
      `,
          ...
          (t.add(s), (i.position.z = 30));
          let o = () => {
            (requestAnimationFrame(o),
              (a.u_time.value = r.getElapsedTime()),
              (s.rotation.y += 5e-4),
              n.render(t, i));
          };
          o();
          ...
          return (
            ...
            () => {
              (window.removeEventListener("resize", l),
                e.current && e.current.removeChild(n.domElement));
            }
          );
        }, []),
        (0, r.jsxs)(r.Fragment, {
          children: [
            (0, r.jsx)("div", { id: "animation-container", ref: e }),
            (0, r.jsx)("div", {
              id: "title-overlay",
              children: "AI QUANTUM CHARTS",
            }),
          ],
        })
      );
